export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	venusaur: {
		...
		types: ["Grass", "Poison"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 92, def: 83, spa: 120, spd: 110, spe: 80},
		abilities: {0: "Water Absorb", H: "Chlorophyll"},
		heightm: 2,
		weightkg: 100,
		color: "Green",
		prevo: "Ivysaur",
	...
	venusaurmega: {
		...
		types: ["Grass", "Poison"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 110, def: 123, spa: 142, spd: 130, spe: 60},
	...
	charizard: {
		...
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 98, atk: 104, def: 78, spa: 129, spd: 85, spe: 100},
		abilities: {0: "Flame Touch", H: "Solar Power"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
		prevo: "Charmeleon",
	...
	charizardmegax: {
		...
		types: ["Fire", "Dragon"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 98, atk: 140, def: 111, spa: 120, spd: 85, spe: 100},
	...
	charizardmegay: {
		...
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 98, atk: 94, def: 78, spa: 159, spd: 115, spe: 110},
		abilities: {0: "Drought"},
		heightm: 1.7,
		weightkg: 100.5,
		color: "Red",
	...
	blastoise: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 99, atk: 103, def: 120, spa: 105, spd: 105, spe: 58},
	...
	blastoisemega: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 99, atk: 103, def: 130, spa: 145, spd: 115, spe: 58},
	...
	butterfree: {
		...
		name: "Butterfree",
		types: ["Bug", "Flying"],
		baseStats: {hp: 70, atk: 45, def: 50, spa: 110, spd: 100, spe: 80},
	...
	beedrill: {
		...
		name: "Beedrill",
		types: ["Bug", "Poison"],
		baseStats: {hp: 65, atk: 110, def: 40, spa: 55, spd: 80, spe: 105},
		abilities: {0: "Poison Touch", H: "Sniper"},
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "Kakuna",
	...
	beedrillmega: {
		...
		forme: "Mega",
		types: ["Bug", "Poison"],
		baseStats: {hp: 65, atk: 150, def: 40, spa: 55, spd: 80, spe: 145},
	...
	pidgeot: {
		...
		name: "Pidgeot",
		types: ["Normal", "Flying"],
		baseStats: {hp: 83, atk: 100, def: 75, spa: 100, spd: 70, spe: 111},
		abilities: {0: "Gale Wings", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 1.5,
		weightkg: 39.5,
		color: "Brown",
		prevo: "Pidgeotto",
	...
	pidgeotmega: {
		...
		forme: "Mega",
		types: ["Normal", "Flying"],
		baseStats: {hp: 83, atk: 100, def: 80, spa: 150, spd: 80, spe: 126},
	...
	raticate: {
		...
		name: "Raticate",
		types: ["Normal"],
		baseStats: {hp: 85, atk: 101, def: 60, spa: 50, spd: 70, spe: 107},
		abilities: {0: "Run Away", 1: "Guts", H: "Hustle"},
		heightm: 0.7,
		weightkg: 18.5,
		color: "Brown",
	...
	raticatealola: {
		...
		forme: "Alola",
		types: ["Dark", "Normal"],
		baseStats: {hp: 105, atk: 101, def: 70, spa: 40, spd: 80, spe: 77},
		abilities: {0: "Gluttony", 1: "Hustle", H: "Thick Fat"},
		heightm: 0.7,
		weightkg: 25.5,
		color: "Black",
	...
	fearow: {
		...
		name: "Fearow",
		types: ["Normal", "Flying"],
		baseStats: {hp: 75, atk: 120, def: 65, spa: 61, spd: 61, spe: 120},
		abilities: {0: "Sharp Beak", H: "Sniper"},
		heightm: 1.2,
		weightkg: 38,
		color: "Brown",
		prevo: "Spearow",
	...
	arbok: {
		...
		name: "Arbok",
		types: ["Poison"],
		baseStats: {hp: 60, atk: 125, def: 79, spa: 65, spd: 99, spe: 90},
	...
	pikachu: {
		...
		name: "Pikachu",
		types: ["Electric"],
		baseStats: {hp: 65, atk: 65, def: 40, spa: 60, spd: 50, spe: 100},
		abilities: {0: "Plot Armor", H: "Lightning Rod"},
		heightm: 0.4,
		weightkg: 6,
		color: "Yellow",
		prevo: "Pichu",
	...
	raichu: {
		...
		name: "Raichu",
		types: ["Electric"],
		baseStats: {hp: 70, atk: 90, def: 55, spa: 110, spd: 80, spe: 140},
		abilities: {0: "Static", H: "Lightning Rod"},
		heightm: 0.8,
		weightkg: 30,
		color: "Yellow",
	...
	raichualola: {
		...
		baseStats: {hp: 70, atk: 85, def: 50, spa: 115, spd: 95, spe: 130},
	...
	sandslash: {
		...
		name: "Sandslash",
		types: ["Ground"],
		baseStats: {hp: 85, atk: 130, def: 110, spa: 45, spd: 75, spe: 65},
		abilities: {0: "Sharpness", H: "Sand Rush"},
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "Sandshrew",
	...
	sandslashalola: {
		...
		forme: "Alola",
		types: ["Ice", "Steel"],
		baseStats: {hp: 85, atk: 130, def: 140, spa: 25, spd: 65, spe: 65},
		abilities: {0: "Sharpness", H: "Slush Rush"},
		heightm: 1.2,
		weightkg: 55,
		color: "Blue",
	...
	nidoqueen: {
		...
		types: ["Poison", "Ground"],
		gender: "F",
		baseStats: {hp: 110, atk: 102, def: 97, spa: 95, spd: 85, spe: 76},
		abilities: {0: "Poison Point", 1: "Queenly Majesty", H: "Sheer Force"},
		heightm: 1.3,
		weightkg: 60,
		color: "Blue",
		prevo: "Nidorina",
	...
	nidoking: {
		...
		types: ["Poison", "Ground"],
		gender: "M",
		baseStats: {hp: 101, atk: 112, def: 87, spa: 95, spd: 85, spe: 85},
		abilities: {0: "Poison Point", 1: "Intimidate", H: "Sheer Force"},
		heightm: 1.4,
		weightkg: 62,
		color: "Purple",
		prevo: "Nidorino",
	...
	clefairy: {
		...
		baseStats: {hp: 70, atk: 45, def: 68, spa: 80, spd: 85, spe: 35},
		abilities: {0: "Cute Charm", 1: "Magic Guard", H: "Moon Veil"},
		heightm: 0.6,
		weightkg: 7.5,
		color: "Pink",
		prevo: "Cleffa",
	...
	clefable: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 95, atk: 70, def: 73, spa: 105, spd: 90, spe: 70},
	...
	ninetales: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 83, atk: 86, def: 75, spa: 91, spd: 120, spe: 110},
		abilities: {0: "Flash Fire", H: "Drought"},
		heightm: 1.1,
		weightkg: 19.9,
		color: "Yellow",
	...
	ninetalesalola: {
		...
		types: ["Ice", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 83, atk: 67, def: 75, spa: 101, spd: 120, spe: 119},
		abilities: {0: "Snow Cloak", H: "Snow Warning"},
		heightm: 1.1,
		weightkg: 19.9,
		color: "Blue",
	...
	jigglypuff: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 135, atk: 45, def: 40, spa: 45, spd: 45, spe: 20},
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Puff Out"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Pink",
		prevo: "Igglybuff",
	...
	wigglytuff: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 160, atk: 70, def: 65, spa: 85, spd: 70, spe: 45},
		abilities: {0: "Cute Charm", 1: "Competitive", H: "Puff Out"},
		heightm: 1,
		weightkg: 12,
		color: "Pink",
	...
	vileplume: {
		...
		name: "Vileplume",
		types: ["Grass", "Poison"],
		baseStats: {hp: 75, atk: 80, def: 95, spa: 130, spd: 120, spe: 50},
	...
	parasect: {
		...
		name: "Parasect",
		types: ["Bug", "Grass"],
		baseStats: {hp: 100, atk: 115, def: 80, spa: 60, spd: 80, spe: 30},
	...
	venomoth: {
		...
		name: "Venomoth",
		types: ["Bug", "Poison"],
		baseStats: {hp: 80, atk: 75, def: 60, spa: 110, spd: 95, spe: 90},
	...
	dugtrio: {
		...
		name: "Dugtrio",
		types: ["Ground"],
		baseStats: {hp: 65, atk: 35, def: 50, spa: 50, spd: 70, spe: 140},
		abilities: {0: "Power Of Three", 1: "Arena Trap", H: "Sand Force"},
		heightm: 0.7,
		weightkg: 33.3,
		color: "Brown",
		prevo: "Diglett",
	...
	dugtrioalola: {
		...
		forme: "Alola",
		types: ["Ground", "Steel"],
		baseStats: {hp: 70, atk: 40, def: 60, spa: 50, spd: 70, spe: 120},
		abilities: {0: "Power Of Three", 1: "Tangling Hair", H: "Sand Force"},
		heightm: 0.7,
		weightkg: 66.6,
		color: "Brown",
		prevo: "Diglett-Alola",
	...
	persian: {
		...
		name: "Persian",
		types: ["Normal"],
		baseStats: {hp: 65, atk: 90, def: 60, spa: 85, spd: 65, spe: 135},
		abilities: {0: "Normalize", 1: "Technician", H: "Unnerve"},
		heightm: 1,
		weightkg: 32,
		color: "Yellow",
		prevo: "Meowth",
	...
	persianalola: {
		...
		forme: "Alola",
		types: ["Dark"],
		baseStats: {hp: 65, atk: 80, def: 60, spa: 95, spd: 65, spe: 135},
		abilities: {0: "Fur Coat", 1: "Technician", H: "Darken"},
		heightm: 1.1,
		weightkg: 33,
		color: "Blue",
		prevo: "Meowth-Alola",
	...
	golduck: {
		...
		name: "Golduck",
		types: ["Water"],
		baseStats: {hp: 80, atk: 82, def: 78, spa: 125, spd: 110, spe: 85},
		abilities: {0: "Unaware", 1: "Cloud Nine", H: "Swift Swim"},
		heightm: 1.7,
		weightkg: 76.6,
		color: "Blue",
		prevo: "Psyduck",
	...
	arcanine: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 110, atk: 125, def: 80, spa: 115, spd: 80, spe: 105},
		abilities: {0: "Intimidate", 1: "Flash Fire", H: "Majestic Aura"},
		heightm: 1.9,
		weightkg: 155,
		color: "Brown",
		prevo: "Growlithe",
	...
	arcaninehisui: {
		...
		types: ["Fire", "Rock"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 115, atk: 115, def: 80, spa: 95, spd: 80, spe: 90},
		abilities: {0: "Intimidate", 1: "Flash Fire", H: "Rock Head"},
		heightm: 2,
		weightkg: 168,
		color: "Brown",
	...
	poliwrath: {
		...
		baseStats: {hp: 120, atk: 105, def: 105, spa: 70, spd: 100, spe: 70},
		abilities: {0: "Water Absorb", 1: "Confusing Body", H: "Swift Swim"},
		heightm: 1.3,
		weightkg: 54,
		color: "Blue",
		prevo: "Poliwhirl",
	...
	alakazam: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 50, def: 45, spa: 155, spd: 95, spe: 120},
		abilities: {0: "Synchronize", 1: "Inner Focus", H: "Magic Guard"},
		heightm: 1.5,
		weightkg: 48,
		color: "Brown",
	...
	alakazammega: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 50, def: 65, spa: 195, spd: 105, spe: 150},
		abilities: {0: "Trace"},
		heightm: 1.2,
		weightkg: 48,
		color: "Brown",
	...
	machamp: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 90, atk: 150, def: 100, spa: 65, spd: 105, spe: 55},
		abilities: {0: "Guts", 1: "No Guard", H: "Steadfast"},
		heightm: 1.6,
		weightkg: 130,
		color: "Gray",
	...
	victreebel: {
		...
		name: "Victreebel",
		types: ["Grass", "Poison"],
		baseStats: {hp: 100, atk: 115, def: 75, spa: 110, spd: 80, spe: 70},
		abilities: {0: "Flytrap", H: "Gluttony"},
		heightm: 1.7,
		weightkg: 15.5,
		color: "Green",
		prevo: "Weepinbell",
	...
	tentacruel: {
		...
		name: "Tentacruel",
		types: ["Water", "Poison"],
		baseStats: {hp: 90, atk: 80, def: 65, spa: 90, spd: 150, spe: 100},
		abilities: {0: "Aftermath", 1: "Liquid Ooze", H: "Rain Dish"},
		heightm: 1.6,
		weightkg: 55,
		color: "Blue",
		prevo: "Tentacool",
	...
	golem: {
		...
		name: "Golem",
		types: ["Rock", "Ground"],
		baseStats: {hp: 80, atk: 130, def: 160, spa: 55, spd: 85, spe: 45},
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Rock Down"},
		heightm: 1.4,
		weightkg: 300,
		color: "Brown",
		prevo: "Graveler",
	...
	golemalola: {
		...
		forme: "Alola",
		types: ["Rock", "Electric"],
		baseStats: {hp: 80, atk: 140, def: 150, spa: 55, spd: 85, spe: 45},
		abilities: {0: "Rock Down", 1: "Sturdy", H: "Galvanize"},
		heightm: 1.7,
		weightkg: 316,
		color: "Gray",
	...
	rapidash: {
		...
		name: "Rapidash",
		types: ["Fire"],
		baseStats: {hp: 85, atk: 120, def: 70, spa: 80, spd: 80, spe: 125},
		abilities: {0: "Flame Touch", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1.7,
		weightkg: 95,
		color: "Yellow",
		prevo: "Ponyta",
	...
	rapidashgalar: {
		...
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 85, atk: 120, def: 70, spa: 80, spd: 80, spe: 125},
		abilities: {0: "Cute Touch", 1: "Pastel Veil", H: "Anticipation"},
		heightm: 1.7,
		weightkg: 80,
		color: "White",
		prevo: "Ponyta-Galar",
	...
	slowbro: {
		...
		name: "Slowbro",
		types: ["Water", "Psychic"],
		baseStats: {hp: 95, atk: 95, def: 130, spa: 110, spd: 90, spe: 30},
		abilities: {0: "Dementia", 1: "Own Tempo", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 78.5,
		color: "Pink",
		prevo: "Slowpoke",
	...
	slowbromega: {
		...
		forme: "Mega",
		types: ["Water", "Psychic"],
		baseStats: {hp: 95, atk: 95, def: 200, spa: 140, spd: 90, spe: 30},
	...
	slowbrogalar: {
		...
		baseStats: {hp: 95, atk: 120, def: 105, spa: 120, spd: 80, spe: 30},
	...
	magneton: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: {hp: 50, atk: 70, def: 125, spa: 130, spd: 80, spe: 70},
		abilities: {0: "Magnet Pull", 1: "Sturdy", H: "Analytic"},
		heightm: 1,
		weightkg: 60,
		color: "Gray",
	...
	farfetchd: {
		...
		name: "Farfetch\u2019d",
		types: ["Normal", "Flying"],
		baseStats: {hp: 92, atk: 100, def: 55, spa: 58, spd: 62, spe: 90},
		abilities: {0: "Sniper", 1: "Scrappy", H: "Defiant"},
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
	...
	dodrio: {
		...
		name: "Dodrio",
		types: ["Normal", "Flying"],
		baseStats: {hp: 90, atk: 40, def: 90, spa: 30, spd: 80, spe: 120},
		abilities: {0: "Power Of Three", 1: "Early Bird", H: "Tangled Feet"},
		heightm: 1.8,
		weightkg: 85.2,
		color: "Brown",
		prevo: "Doduo",
	...
	dewgong: {
		...
		name: "Dewgong",
		types: ["Water", "Ice"],
		baseStats: {hp: 130, atk: 80, def: 80, spa: 80, spd: 95, spe: 70},
		abilities: {0: "Thick Fat", 1: "Hydration", H: "Slippery"},
		heightm: 1.7,
		weightkg: 120,
		color: "White",
		prevo: "Seel",
	...
	muk: {
		...
		name: "Muk",
		types: ["Poison"],
		baseStats: {hp: 125, atk: 115, def: 85, spa: 65, spd: 120, spe: 50},
		abilities: {0: "Pollution", 1: "Corrosion", H: "Poison Touch"},
		heightm: 1.2,
		weightkg: 30,
		color: "Purple",
		prevo: "Grimer",
	...
	mukalola: {
		...
		types: ["Poison", "Dark"],
		baseStats: {hp: 125, atk: 115, def: 85, spa: 65, spd: 120, spe: 50},
		abilities: {0: "Corrosion", 1: "Gluttony", H: "Power of Alchemy"},
		heightm: 1,
		weightkg: 52,
		color: "Green",
		prevo: "Grimer-Alola",
	...
	cloyster: {
		...
		name: "Cloyster",
		types: ["Water", "Ice"],
		baseStats: {hp: 70, atk: 95, def: 200, spa: 85, spd: 45, spe: 70},
		abilities: {0: "Shell Armor", 1: "Skill Link", H: "Anger Shell"},
		heightm: 1.5,
		weightkg: 132.5,
		color: "Purple",
		prevo: "Shellder",
	...
	gengar: {
		...
		name: "Gengar",
		types: ["Ghost", "Poison"],
		baseStats: {hp: 60, atk: 65, def: 70, spa: 140, spd: 85, spe: 120},
	...
	onix: {
		...
		name: "Onix",
		types: ["Rock", "Ground"],
		baseStats: {hp: 65, atk: 75, def: 160, spa: 30, spd: 45, spe: 70},
	...
	hypno: {
		...
		name: "Hypno",
		types: ["Psychic"],
		baseStats: {hp: 85, atk: 93, def: 70, spa: 93, spd: 135, spe: 67},
		abilities: {0: "Insomnia", 1: "Forewarn", H: "Drowsy Aura"},
		heightm: 1.6,
		weightkg: 75.6,
		color: "Yellow",
		prevo: "Drowzee",
	...
	kingler: {
		...
		name: "Kingler",
		types: ["Water"],
		baseStats: {hp: 65, atk: 160, def: 125, spa: 50, spd: 50, spe: 85},
	...
	electrode: {
		...
		types: ["Electric"],
		gender: "N",
		baseStats: {hp: 60, atk: 50, def: 80, spa: 90, spd: 90, spe: 180},
		abilities: {0: "Soundproof", 1: "Static", H: "Aftermath"},
		heightm: 1.2,
		weightkg: 66.6,
		color: "Red",
	...
	exeggutor: {
		...
		name: "Exeggutor",
		types: ["Grass", "Psychic"],
		baseStats: {hp: 125, atk: 95, def: 95, spa: 135, spd: 85, spe: 55},
		abilities: {0: "Ripen", H: "Harvest"},
		heightm: 2,
		weightkg: 120,
		color: "Yellow",
		prevo: "Exeggcute",
	...
	exeggutoralola: {
		...
		forme: "Alola",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 125, atk: 125, def: 95, spa: 125, spd: 85, spe: 45},
		abilities: {0: "Ripen", H: "Harvest"},
		heightm: 10.9,
		weightkg: 415.6,
		color: "Yellow",
	...
	marowak: {
		...
		name: "Marowak",
		types: ["Ground"],
		baseStats: {hp: 80, atk: 90, def: 130, spa: 50, spd: 90, spe: 45},
		abilities: {0: "Rock Head", 1: "Skill Link", H: "Battle Armor"},
		heightm: 1,
		weightkg: 45,
		color: "Brown",
		prevo: "Cubone",
	...
	marowakalola: {
		...
		types: ["Fire", "Ghost"],
		baseStats: {hp: 80, atk: 90, def: 130, spa: 50, spd: 90, spe: 45},
		abilities: {0: "Cursed Body", 1: "Dancer", H: "Rock Head"},
		heightm: 1,
		weightkg: 34,
		color: "Purple",
		prevo: "Cubone",
	...
	hitmonlee: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 130, def: 53, spa: 35, spd: 130, spe: 97},
		abilities: {0: "Adrenaline", 1: "Reckless", H: "Unburden"},
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "Tyrogue",
	...
	hitmonchan: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 115, def: 89, spa: 35, spd: 130, spe: 76},
		abilities: {0: "Adrenaline", 1: "Iron Fist", H: "Inner Focus"},
		heightm: 1.4,
		weightkg: 50.2,
		color: "Brown",
		prevo: "Tyrogue",
	...
	lickitung: {
		...
		name: "Lickitung",
		types: ["Normal"],
		baseStats: {hp: 120, atk: 75, def: 75, spa: 80, spd: 75, spe: 30},
		abilities: {0: "Own Tempo", 1: "Squelch", H: "Cloud Nine"},
		heightm: 1.2,
		weightkg: 65.5,
		color: "Pink",
		evos: ["Lickilicky"],
	...
	weezing: {
		...
		name: "Weezing",
		types: ["Poison"],
		baseStats: {hp: 75, atk: 100, def: 140, spa: 95, spd: 80, spe: 60},
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Toxic Surge"},
		heightm: 1.2,
		weightkg: 9.5,
		color: "Purple",
		prevo: "Koffing",
	...
	rhydon: {
		...
		name: "Rhydon",
		types: ["Ground", "Rock"],
		baseStats: {hp: 105, atk: 150, def: 130, spa: 45, spd: 65, spe: 50},
		abilities: {0: "Sheer Force", 1: "Rock Head", H: "Reckless"},
		heightm: 1.9,
		weightkg: 120,
		color: "Gray",
		prevo: "Rhyhorn",
	...
	chansey: {
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 250, atk: 15, def: 5, spa: 65, spd: 105, spe: 50},
	...
	tangela: {
		...
		name: "Tangela",
		types: ["Grass"],
		baseStats: {hp: 85, atk: 55, def: 135, spa: 110, spd: 50, spe: 60},
		abilities: {0: "Thorn Trapper", 1: "Tangling Hair", H: "Regenerator"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		evos: ["Tangrowth"],
	...
	kangaskhan: {
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 125, atk: 115, def: 90, spa: 40, spd: 90, spe: 90},
	...
	kangaskhanmega: {
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 125, atk: 125, def: 90, spa: 60, spd: 90, spe: 100},
	...
	seadra: {
		...
		name: "Seadra",
		types: ["Water"],
		baseStats: {hp: 75, atk: 65, def: 105, spa: 115, spd: 45, spe: 95},
		abilities: {0: "Poison Point", 1: "Sniper", H: "Majestic Aura"},
		heightm: 1.2,
		weightkg: 25,
		color: "Blue",
		prevo: "Horsea",
	...
	seaking: {
		...
		name: "Seaking",
		types: ["Water"],
		baseStats: {hp: 90, atk: 112, def: 75, spa: 65, spd: 100, spe: 88},
	...
	starmie: {
		...
		types: ["Water", "Psychic"],
		gender: "N",
		baseStats: {hp: 90, atk: 75, def: 85, spa: 120, spd: 85, spe: 125},
	...
	mrmime: {
		...
		name: "Mr. Mime",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 60, atk: 45, def: 75, spa: 110, spd: 140, spe: 90},
		abilities: {0: "Mirror Armor", 1: "Filter", H: "Technician"},
		heightm: 1.3,
		weightkg: 54.5,
		color: "Pink",
		prevo: "Mime Jr.",
	...
	scyther: {
		...
		name: "Scyther",
		types: ["Bug", "Flying"],
		baseStats: {hp: 80, atk: 120, def: 90, spa: 75, spd: 90, spe: 105},
		abilities: {0: "Sharpness", 1: "Technician", H: "Steadfast"},
		heightm: 1.5,
		weightkg: 56,
		color: "Green",
		evos: ["Scizor", "Kleavor"],
	...
	jynx: {
		...
		baseStats: {hp: 85, atk: 50, def: 65, spa: 125, spd: 105, spe: 105},
		abilities: {0: "Glacial Reflection", 1: "Forewarn", H: "Dry Skin"},
		heightm: 1.4,
		weightkg: 40.6,
		color: "Red",
		prevo: "Smoochum",
	...
	electabuzz: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 93, def: 67, spa: 105, spd: 95, spe: 115},
		abilities: {0: "Static", H: "Amplify"},
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "Elekid",
	...
	magmar: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 75, atk: 105, def: 67, spa: 110, spd: 95, spe: 103},
		abilities: {0: "Flame Body", H: "Fire Maw"},
		heightm: 1.3,
		weightkg: 44.5,
		color: "Red",
		prevo: "Magby",
	...
	pinsir: {
		...
		name: "Pinsir",
		types: ["Bug"],
		baseStats: {hp: 75, atk: 135, def: 120, spa: 65, spd: 80, spe: 85},
	...
	pinsirmega: {
		...
		forme: "Mega",
		types: ["Bug", "Flying"],
		baseStats: {hp: 75, atk: 155, def: 130, spa: 65, spd: 90, spe: 105},
	...
	tauros: {
		...
		types: ["Normal"],
		gender: "M",
		baseStats: {hp: 95, atk: 120, def: 105, spa: 40, spd: 70, spe: 120},
	...
	taurospaldeacombat: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 95, atk: 130, def: 115, spa: 30, spd: 70, spe: 110},
		abilities: {0: "Intimidate", 1: "Reckless", H: "Cud Chew"},
		heightm: 1.4,
		weightkg: 88.4,
		color: "Black",
		eggGroups: ["Field"],
	...
	gyarados: {
		...
		name: "Gyarados",
		types: ["Water", "Flying"],
		baseStats: {hp: 95, atk: 145, def: 89, spa: 60, spd: 110, spe: 81},
		abilities: {0: "Draconic", H: "Moxie"},
		heightm: 6.5,
		weightkg: 235,
		color: "Blue",
		prevo: "Magikarp",
	...
	gyaradosmega: {
		...
		forme: "Mega",
		types: ["Water", "Dark"],
		baseStats: {hp: 95, atk: 165, def: 109, spa: 70, spd: 140, spe: 81},
	...
	lapras: {
		...
		name: "Lapras",
		types: ["Water", "Ice"],
		baseStats: {hp: 150, atk: 95, def: 90, spa: 95, spd: 105, spe: 60},
		abilities: {0: "Water Absorb", 1: "Serene Swim", H: "Hydration"},
		heightm: 2.5,
		weightkg: 220,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	eevee: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 65, def: 60, spa: 55, spd: 75, spe: 65},
	...
	vaporeon: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 150, atk: 65, def: 70, spa: 120, spd: 115, spe: 65},
	...
	jolteon: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 75, def: 70, spa: 120, spd: 105, spe: 150},
	...
	flareon: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 150, def: 60, spa: 115, spd: 120, spe: 75},
	...
	porygon: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 65, atk: 70, def: 80, spa: 105, spd: 95, spe: 40},
		abilities: {0: "Trace", 1: "Download", H: "Glitchy Surge"},
		heightm: 0.8,
		weightkg: 36.5,
		color: "Pink",
		evos: ["Porygon2"],
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 145, spa: 135, spd: 90, spe: 55},
		abilities: {0: "Swift Swim", 1: "Fossilize", H: "Weak Armor"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		prevo: "Omanyte",
	...
	kabutops: {
		...
		types: ["Rock", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 135, def: 125, spa: 65, spd: 80, spe: 90},
		abilities: {0: "Swift Swim", 1: "Fossilize", H: "Weak Armor"},
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
	...
	aerodactyl: {
		...
		types: ["Rock", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 125, def: 75, spa: 60, spd: 85, spe: 150},
		abilities: {0: "Rock Head", 1: "Fossilize", H: "Unnerve"},
		heightm: 1.8,
		weightkg: 59,
		color: "Purple",
		eggGroups: ["Flying"],
	...
	aerodactylmega: {
		...
		types: ["Rock", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 145, def: 85, spa: 80, spd: 95, spe: 160},
		abilities: {0: "Tough Claws"},
		heightm: 2.1,
		weightkg: 79,
		color: "Purple",
	...
	snorlax: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 180, atk: 120, def: 75, spa: 75, spd: 120, spe: 30},
		abilities: {0: "Sleep Talker", 1: "Thick Fat", H: "Gluttony"},
		heightm: 2.1,
		weightkg: 460,
		color: "Black",
		prevo: "Munchlax",
	...
	articuno: {
		...
		types: ["Ice", "Flying"],
		gender: "N",
		baseStats: {hp: 100, atk: 85, def: 100, spa: 105, spd: 135, spe: 85},
	...
	articunogalar: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 85, def: 95, spa: 135, spd: 110, spe: 95},
	...
	zapdos: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 100, def: 85, spa: 135, spd: 90, spe: 110},
		abilities: {0: "Galvanize", H: "Static"},
		heightm: 1.6,
		weightkg: 52.6,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	zapdosgalar: {
		...
		gender: "N",
		baseStats: {hp: 100, atk: 135, def: 90, spa: 95, spd: 90, spe: 110},
		abilities: {0: "Defiant"},
		heightm: 1.6,
		weightkg: 58.2,
		color: "Yellow",
	...
	moltres: {
		...
		types: ["Fire", "Flying"],
		gender: "N",
		baseStats: {hp: 100, atk: 110, def: 90, spa: 135, spd: 85, spe: 100},
		abilities: {0: "Ignite", H: "Flame Body"},
		heightm: 2,
		weightkg: 60,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	moltresgalar: {
		...
		types: ["Dark", "Flying"],
		gender: "N",
		baseStats: {hp: 100, atk: 85, def: 90, spa: 110, spd: 135, spe: 100},
		abilities: {0: "Berserk"},
		heightm: 2,
		weightkg: 66,
		color: "Red",
	...
	dragonite: {
		...
		name: "Dragonite",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 101, atk: 134, def: 95, spa: 110, spd: 100, spe: 80},
		abilities: {0: "Own Tempo", H: "Multiscale"},
		heightm: 2.2,
		weightkg: 210,
		color: "Brown",
		prevo: "Dragonair",
	...
	meganium: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 92, def: 120, spa: 93, spd: 120, spe: 80},
		abilities: {0: "Grassy Surge", H: "Leaf Guard"},
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
		prevo: "Bayleef",
	...
	typhlosion: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 88, atk: 104, def: 78, spa: 119, spd: 95, spe: 110},
	...
	typhlosionhisui: {
		...
		types: ["Fire", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 83, atk: 104, def: 78, spa: 129, spd: 95, spe: 105},
		abilities: {0: "Berserk", H: "Frisk"},
		heightm: 1.6,
		weightkg: 69.8,
		color: "Yellow",
		prevo: "Quilava",
	...
	feraligatr: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 125, def: 110, spa: 89, spd: 93, spe: 78},
		abilities: {0: "Gluttony", H: "Sheer Force"},
		heightm: 2.3,
		weightkg: 88.8,
		color: "Blue",
		prevo: "Croconaw",
	...
	furret: {
		...
		name: "Furret",
		types: ["Normal"],
		baseStats: {hp: 95, atk: 96, def: 74, spa: 45, spd: 65, spe: 100},
		abilities: {0: "Run Away", 1: "Nimble", H: "Frisk"},
		heightm: 1.8,
		weightkg: 32.5,
		color: "Brown",
		prevo: "Sentret",
	...
	noctowl: {
		...
		name: "Noctowl",
		types: ["Normal", "Flying"],
		baseStats: {hp: 120, atk: 50, def: 60, spa: 96, spd: 116, spe: 70},
		abilities: {0: "Insomnia", 1: "Simple", H: "Tinted Lens"},
		heightm: 1.6,
		weightkg: 40.8,
		color: "Brown",
		prevo: "Hoothoot",
	...
	ledian: {
		...
		name: "Ledian",
		types: ["Bug", "Flying"],
		baseStats: {hp: 65, atk: 65, def: 50, spa: 75, spd: 130, spe: 95},
		abilities: {0: "Pure Power", 1: "Early Bird", H: "Iron Fist"},
		heightm: 1.4,
		weightkg: 35.6,
		color: "Red",
		prevo: "Ledyba",
	...
	ariados: {
		...
		name: "Ariados",
		types: ["Bug", "Poison"],
		baseStats: {hp: 70, atk: 120, def: 110, spa: 60, spd: 90, spe: 70},
		abilities: {0: "Web Spit", 1: "Insomnia", H: "Sniper"},
		heightm: 1.1,
		weightkg: 33.5,
		color: "Red",
		prevo: "Spinarak",
	...
	crobat: {
		...
		name: "Crobat",
		types: ["Poison", "Flying"],
		baseStats: {hp: 85, atk: 100, def: 90, spa: 80, spd: 90, spe: 150},
		abilities: {0: "Merciless", H: "Infiltrator"},
		heightm: 1.8,
		weightkg: 75,
		color: "Purple",
	...
	lanturn: {
		...
		name: "Lanturn",
		types: ["Water", "Electric"],
		baseStats: {hp: 145, atk: 58, def: 78, spa: 96, spd: 96, spe: 67},
		abilities: {0: "Volt Absorb", 1: "Blinding", H: "Water Absorb"},
		heightm: 1.2,
		weightkg: 22.5,
		color: "Blue",
		prevo: "Chinchou",
	...
	togetic: {
		...
		types: ["Fairy", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 65, atk: 40, def: 95, spa: 100, spd: 125, spe: 40},
		abilities: {0: "Wonder Field", 1: "Serene Grace", H: "Risk Taker"},
		heightm: 0.6,
		weightkg: 3.2,
		color: "White",
		prevo: "Togepi",
	...
	xatu: {
		...
		name: "Xatu",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 75, atk: 65, def: 90, spa: 115, spd: 90, spe: 105},
		abilities: {0: "Synchronize", 1: "Magic Field", H: "Magic Bounce"},
		heightm: 1.5,
		weightkg: 15,
		color: "Green",
		prevo: "Natu",
	...
	ampharos: {
		...
		name: "Ampharos",
		types: ["Electric"],
		baseStats: {hp: 100, atk: 85, def: 95, spa: 135, spd: 100, spe: 55},
		abilities: {0: "Static", H: "Blinding"},
		heightm: 1.4,
		weightkg: 61.5,
		color: "Yellow",
		prevo: "Flaaffy",
	...
	ampharosmega: {
		...
		baseStats: {hp: 100, atk: 95, def: 105, spa: 165, spd: 110, spe: 45},
	...
	bellossom: {
		...
		name: "Bellossom",
		types: ["Grass"],
		baseStats: {hp: 85, atk: 100, def: 95, spa: 110, spd: 110, spe: 50},
		abilities: {0: "Chlorophyll", H: "Triage"},
		heightm: 0.4,
		weightkg: 5.8,
		color: "Green",
		prevo: "Gloom",
	...
	marill: {
		...
		name: "Marill",
		types: ["Water", "Fairy"],
		baseStats: {hp: 70, atk: 40, def: 70, spa: 20, spd: 70, spe: 40},
	...
	azumarill: {
		...
		name: "Azumarill",
		types: ["Water", "Fairy"],
		baseStats: {hp: 110, atk: 50, def: 80, spa: 70, spd: 80, spe: 50},
		abilities: {0: "Thick Fat", 1: "Huge Power", H: "Sap Sipper"},
		heightm: 0.8,
		weightkg: 28.5,
		color: "Blue",
	...
	sudowoodo: {
		...
		name: "Sudowoodo",
		types: ["Rock"],
		baseStats: {hp: 70, atk: 120, def: 135, spa: 30, spd: 85, spe: 30},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Petrified"},
		heightm: 1.2,
		weightkg: 38,
		color: "Brown",
		prevo: "Bonsly",
	...
	politoed: {
		...
		name: "Politoed",
		types: ["Water"],
		baseStats: {hp: 100, atk: 75, def: 85, spa: 110, spd: 120, spe: 70},
		abilities: {0: "Water Absorb", 1: "Confusing Body", H: "Drizzle"},
		heightm: 1.1,
		weightkg: 33.9,
		color: "Green",
		prevo: "Poliwhirl",
	...
	jumpluff: {
		...
		name: "Jumpluff",
		types: ["Grass", "Flying"],
		baseStats: {hp: 85, atk: 75, def: 70, spa: 75, spd: 95, spe: 120},
	...
	aipom: {
		...
		name: "Aipom",
		types: ["Normal"],
		baseStats: {hp: 75, atk: 90, def: 55, spa: 40, spd: 55, spe: 105},
	...
	sunflora: {
		...
		name: "Sunflora",
		types: ["Grass"],
		baseStats: {hp: 105, atk: 85, def: 75, spa: 125, spd: 105, spe: 30},
		abilities: {0: "Chlorophyll", 1: "Solar Power", H: "Solar Growth"},
		heightm: 0.8,
		weightkg: 8.5,
		color: "Yellow",
		prevo: "Sunkern",
	...
	yanma: {
		...
		name: "Yanma",
		types: ["Bug", "Flying"],
		baseStats: {hp: 65, atk: 75, def: 55, spa: 95, spd: 55, spe: 105},
	...
	quagsire: {
		...
		name: "Quagsire",
		types: ["Water", "Ground"],
		baseStats: {hp: 105, atk: 95, def: 95, spa: 85, spd: 75, spe: 35},
	...
	espeon: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 65, def: 70, spa: 150, spd: 105, spe: 120},
	...
	umbreon: {
		...
		types: ["Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 75, def: 120, spa: 60, spd: 150, spe: 75},
		abilities: {0: "Synchronize",1: "Adaptability", H: "Inner Focus"},
		heightm: 1,
		weightkg: 27,
		color: "Black",
		prevo: "Eevee",
	...
	murkrow: {
		...
		name: "Murkrow",
		types: ["Dark", "Flying"],
		baseStats: {hp: 70, atk: 105, def: 42, spa: 105, spd: 42, spe: 101},
		abilities: {0: "Insomnia", 1: "Super Luck", H: "Trickster"},
		heightm: 0.5,
		weightkg: 2.1,
		color: "Black",
		evos: ["Honchkrow"],
	...
	slowking: {
		...
		name: "Slowking",
		types: ["Water", "Psychic"],
		baseStats: {hp: 105, atk: 75, def: 90, spa: 120, spd: 130, spe: 30},
		abilities: {0: "Dementia", 1: "Own Tempo", H: "Regenerator"},
		heightm: 2,
		weightkg: 79.5,
		color: "Pink",
	...
	misdreavus: {
		...
		name: "Misdreavus",
		types: ["Ghost"],
		baseStats: {hp: 60, atk: 60, def: 70, spa: 105, spd: 105, spe: 95},
		abilities: {0: "Cursed Voice"},
		heightm: 0.7,
		weightkg: 1,
		color: "Gray",
		evos: ["Mismagius"],
	...
	unown: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 48, atk: 112, def: 88, spa: 112, spd: 88, spe: 88},
		abilities: {0: "Unknown Force"},
		heightm: 0.5,
		weightkg: 5,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	wobbuffet: {
		...
		name: "Wobbuffet",
		types: ["Psychic"],
		baseStats: {hp: 230, atk: 33, def: 68, spa: 33, spd: 68, spe: 33},
		abilities: {0: "Shadow Tag", H: "Regenerator"},
		heightm: 1.3,
		weightkg: 28.5,
		color: "Blue",
		prevo: "Wynaut",
	...
	girafarig: {
		...
		baseStats: {hp: 90, atk: 90, def: 65, spa: 110, spd: 65, spe: 95},
		abilities: {0: "Magic Focus", 1: "Early Bird", H: "Sap Sipper"},
		heightm: 1.5,
		weightkg: 41.5,
		color: "Yellow",
		evos: ["Farigiraf"],
	...
	forretress: {
		...
		name: "Forretress",
		types: ["Bug", "Steel"],
		baseStats: {hp: 75, atk: 110, def: 170, spa: 60, spd: 70, spe: 40},
		abilities: {0: "Sturdy", H: "Heavy Metal"},
		heightm: 1.2,
		weightkg: 125.8,
		color: "Purple",
		prevo: "Pineco",
	...
	dunsparce: {
		...
		name: "Dunsparce",
		types: ["Normal"],
		baseStats: {hp: 120, atk: 80, def: 80, spa: 75, spd: 75, spe: 45},
	...
	gligar: {
		...
		name: "Gligar",
		types: ["Ground", "Flying"],
		baseStats: {hp: 65, atk: 95, def: 125, spa: 35, spd: 75, spe: 95},
		abilities: {0: "Toxic Boost", 1: "Sand Veil", H: "Immunity"},
		heightm: 1.1,
		weightkg: 64.8,
		color: "Purple",
		evos: ["Gliscor"],
	...
	steelix: {
		...
		name: "Steelix",
		types: ["Steel", "Ground"],
		baseStats: {hp: 75, atk: 105, def: 240, spa: 55, spd: 65, spe: 30},
		abilities: {0: "Filter", 1: "Sturdy", H: "Sheer Force"},
		heightm: 9.2,
		weightkg: 400,
		color: "Gray",
		prevo: "Onix",
	...
	steelixmega: {
		...
		forme: "Mega",
		types: ["Steel", "Ground"],
		baseStats: {hp: 75, atk: 135, def: 245, spa: 65, spd: 105, spe: 30},
	...
	granbull: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 100, atk: 140, def: 85, spa: 60, spd: 70, spe: 55},
		abilities: {0: "Intimidate", 1: "Tantrum", H: "Rattled"},
		heightm: 1.4,
		weightkg: 48.7,
		color: "Purple",
		prevo: "Snubbull",
	...
	qwilfish: {
		...
		name: "Qwilfish",
		types: ["Water", "Poison"],
		baseStats: {hp: 75, atk: 115, def: 95, spa: 55, spd: 65, spe: 95},
		abilities: {0: "Poison Point", 1: "Rough Skin", H: "Intimidate"},
		heightm: 0.5,
		weightkg: 3.9,
		color: "Gray",
		eggGroups: ["Water 2"],
	...
	scizor: {
		...
		name: "Scizor",
		types: ["Bug", "Steel"],
		baseStats: {hp: 80, atk: 140, def: 120, spa: 55, spd: 80, spe: 65},
	...
	scizormega: {
		...
		forme: "Mega",
		types: ["Bug", "Steel"],
		baseStats: {hp: 70, atk: 160, def: 150, spa: 65, spd: 100, spe: 75},
	...
	shuckle: {
		...
		name: "Shuckle",
		types: ["Bug", "Rock"],
		baseStats: {hp: 20, atk: 10, def: 240, spa: 10, spd: 240, spe: 5},
		abilities: {0: "Shell Shield", 1: "Gluttony", H: "Contrary"},
		heightm: 0.6,
		weightkg: 20.5,
		color: "Yellow",
		eggGroups: ["Bug"],
	...
	heracross: {
		...
		name: "Heracross",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 90, atk: 145, def: 85, spa: 40, spd: 115, spe: 85},
	...
	heracrossmega: {
		...
		forme: "Mega",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 90, atk: 205, def: 125, spa: 40, spd: 105, spe: 75},
	...
	sneasel: {
		...
		name: "Sneasel",
		types: ["Dark", "Ice"],
		baseStats: {hp: 55, atk: 115, def: 65, spa: 35, spd: 85, spe: 135},
		abilities: {0: "Stealthy Striker", 1: "Keen Eye", H: "Pickpocket"},
		heightm: 0.9,
		weightkg: 28,
		color: "Black",
		evos: ["Weavile"],
	...
	ursaring: {
		...
		name: "Ursaring",
		types: ["Normal"],
		baseStats: {hp: 100, atk: 140, def: 85, spa: 85, spd: 85, spe: 65},
	...
	magcargo: {
		...
		name: "Magcargo",
		types: ["Fire", "Rock"],
		baseStats: {hp: 70, atk: 50, def: 140, spa: 100, spd: 100, spe: 30},
		abilities: {0: "Magma Armor", 1: "Magma Burst", H: "Weak Armor"},
		heightm: 0.8,
		weightkg: 55,
		color: "Red",
		prevo: "Slugma",
	...
	piloswine: {
		...
		name: "Piloswine",
		types: ["Ice", "Ground"],
		baseStats: {hp: 120, atk: 120, def: 90, spa: 60, spd: 70, spe: 50},
		abilities: {0: "Oblivious", 1: "Snow Cloak", H: "Thick Fat"},
		heightm: 1.1,
		weightkg: 55.8,
		color: "Brown",
	...
	corsola: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 95, atk: 65, def: 105, spa: 85, spd: 105, spe: 35},
		abilities: {0: "Hustle", 1: "Aqua Cure", H: "Regenerator"},
		heightm: 0.6,
		weightkg: 5,
		color: "Pink",
		eggGroups: ["Water 1", "Water 3"],
	...
	corsolagalar: {
		...
		types: ["Ghost"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 90, atk: 65, def: 100, spa: 85, spd: 100, spe: 30},
		abilities: {0: "Destiny Curse", H: "Cursed Body"},
		heightm: 0.6,
		weightkg: 0.5,
		color: "White",
		evos: ["Cursola"],
	...
	octillery: {
		...
		name: "Octillery",
		types: ["Water"],
		baseStats: {hp: 95, atk: 125, def: 75, spa: 125, spd: 75, spe: 45},
		abilities: {0: "Trigger Happy", 1: "Sniper", H: "Moody"},
		heightm: 0.9,
		weightkg: 28.5,
		color: "Red",
		prevo: "Remoraid",
	...
	delibird: {
		...
		name: "Delibird",
		types: ["Ice", "Flying"],
		baseStats: {hp: 75, atk: 85, def: 45, spa: 85, spd: 45, spe: 75},
		abilities: {0: "Intrepid Present", 1: "Hustle", H: "Insomnia"},
		heightm: 0.9,
		weightkg: 16,
		color: "Red",
		eggGroups: ["Water 1", "Field"],
	...
	mantine: {
		...
		name: "Mantine",
		types: ["Water", "Flying"],
		baseStats: {hp: 95, atk: 40, def: 80, spa: 90, spd: 170, spe: 70},
		abilities: {0: "Serene Swim", 1: "Water Absorb", H: "Water Veil"},
		heightm: 2.1,
		weightkg: 220,
		color: "Purple",
		prevo: "Mantyke",
	...
	skarmory: {
		...
		name: "Skarmory",
		types: ["Steel", "Flying"],
		baseStats: {hp: 75, atk: 90, def: 160, spa: 40, spd: 70, spe: 70},
	...
	houndoom: {
		...
		name: "Houndoom",
		types: ["Dark", "Fire"],
		baseStats: {hp: 85, atk: 90, def: 60, spa: 130, spd: 80, spe: 115},
		abilities: {0: "Savage Trick", 1: "Flash Fire", H: "Unnerve"},
		heightm: 1.4,
		weightkg: 35,
		color: "Black",
		prevo: "Houndour",
	...
	houndoommega: {
		...
		forme: "Mega",
		types: ["Dark", "Fire"],
		baseStats: {hp: 85, atk: 90, def: 90, spa: 160, spd: 90, spe: 125},
	...
	kingdra: {
		...
		name: "Kingdra",
		types: ["Water", "Dragon"],
		baseStats: {hp: 85, atk: 105, def: 95, spa: 105, spd: 95, spe: 95},
		abilities: {0: "Swift Swim", 1: "Sniper", H: "Sea Twister"},
		heightm: 1.8,
		weightkg: 152,
		color: "Blue",
		prevo: "Seadra",
	...
	donphan: {
		...
		name: "Donphan",
		types: ["Ground"],
		baseStats: {hp: 100, atk: 130, def: 140, spa: 60, spd: 70, spe: 50},
		abilities: {0: "Sturdy", H: "Stampede"},
		heightm: 1.1,
		weightkg: 120,
		color: "Gray",
		prevo: "Phanpy",
	...
	porygon2: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 85, atk: 90, def: 100, spa: 105, spd: 105, spe: 70},
		abilities: {0: "Trace", 1: "Download", H: "Glitchy Surge"},
		heightm: 0.6,
		weightkg: 32.5,
		color: "Red",
	...
	stantler: {
		...
		name: "Stantler",
		types: ["Normal"],
		baseStats: {hp: 83, atk: 105, def: 72, spa: 95, spd: 75, spe: 95},
		abilities: {0: "Intimidate", 1: "Regal Bearing", H: "Sap Sipper"},
		heightm: 1.4,
		weightkg: 71.2,
		color: "Brown",
		evos: ["Wyrdeer"],
	...
	smeargle: {
		...
		name: "Smeargle",
		types: ["Normal"],
		baseStats: {hp: 55, atk: 40, def: 55, spa: 40, spd: 65, spe: 75},
	...
	hitmontop: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 70, atk: 105, def: 105, spa: 35, spd: 120, spe: 80},
		abilities: {0: "Intimidate", 1: "Technician", H: "Adrenaline"},
		heightm: 1.4,
		weightkg: 48,
		color: "Brown",
		prevo: "Tyrogue",
	...
	miltank: {
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 105, atk: 100, def: 125, spa: 40, spd: 70, spe: 110},
		abilities: {0: "Thick Fat", 1: "Scrappy", H: "Dairy Queen"},
		heightm: 1.2,
		weightkg: 75.5,
		color: "Pink",
		eggGroups: ["Field"],
	...
	blissey: {
		...
		types: ["Normal"],
		gender: "F",
		baseStats: {hp: 255, atk: 50, def: 10, spa: 75, spd: 135, spe: 55},
		abilities: {0: "Natural Cure", 1: "Tactical Eggsploder", H: "Healer"},
		heightm: 1.5,
		weightkg: 46.8,
		color: "Pink",
		prevo: "Chansey",
	...
	raikou: {
		...
		types: ["Electric"],
		gender: "N",
		baseStats: {hp: 90, atk: 85, def: 75, spa: 125, spd: 110, spe: 135},
	...
	entei: {
		...
		types: ["Fire"],
		gender: "N",
		baseStats: {hp: 125, atk: 135, def: 85, spa: 90, spd: 75, spe: 110},
	...
	suicune: {
		...
		types: ["Water"],
		gender: "N",
		baseStats: {hp: 110, atk: 75, def: 135, spa: 90, spd: 125, spe: 85},
	...
	tyranitar: {
		...
		name: "Tyranitar",
		types: ["Rock", "Dark"],
		baseStats: {hp: 100, atk: 144, def: 120, spa: 95, spd: 100, spe: 61},
	...
	tyranitarmega: {
		...
		forme: "Mega",
		types: ["Rock", "Dark"],
		baseStats: {hp: 100, atk: 174, def: 160, spa: 95, spd: 120, spe: 71},
	...
	sceptile: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 95, def: 65, spa: 125, spd: 85, spe: 140},
		abilities: {0: "Draconic", H: "Unburden"},
		heightm: 1.7,
		weightkg: 52.2,
		color: "Green",
		prevo: "Grovyle",
	...
	sceptilemega: {
		...
		types: ["Grass", "Dragon"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 120, def: 75, spa: 155, spd: 85, spe: 155},
		abilities: {0: "Lightning Rod"},
		heightm: 1.9,
		weightkg: 55.2,
		color: "Green",
	...
	blaziken: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 130, def: 70, spa: 120, spd: 70, spe: 90},
		abilities: {0: "Flame Touch", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 52,
		color: "Red",
		prevo: "Combusken",
	...
	blazikenmega: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 170, def: 80, spa: 140, spd: 80, spe: 100},
	...
	swampert: {
		...
		types: ["Water", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 130, def: 100, spa: 95, spd: 100, spe: 60},
		abilities: {0: "Muddy", H: "Damp"},
		heightm: 1.5,
		weightkg: 81.9,
		color: "Blue",
		prevo: "Marshtomp",
	...
	swampertmega: {
		...
		types: ["Water", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 160, def: 120, spa: 95, spd: 120, spe: 70},
	...
	mightyena: {
		...
		name: "Mightyena",
		types: ["Dark"],
		baseStats: {hp: 80, atk: 120, def: 80, spa: 60, spd: 60, spe: 80},
		abilities: {0: "Savage Trick", 1: "Quick Feet", H: "Moxie"},
		heightm: 1,
		weightkg: 37,
		color: "Gray",
		prevo: "Poochyena",
	...
	linoone: {
		...
		name: "Linoone",
		types: ["Normal"],
		baseStats: {hp: 88, atk: 80, def: 71, spa: 50, spd: 71, spe: 120},
		abilities: {0: "Hustle", 1: "Gluttony", H: "Quick Feet"},
		heightm: 0.5,
		weightkg: 32.5,
		color: "White",
		prevo: "Zigzagoon",
	...
	wurmple: {
		...
		abilities: {0: "Shield Dust", H: "Poison Point"},
		heightm: 0.3,
		weightkg: 3.6,
		color: "Red",
	...
	beautifly: {
		...
		name: "Beautifly",
		types: ["Bug", "Flying"],
		baseStats: {hp: 70, atk: 70, def: 60, spa: 120, spd: 60, spe: 75},
		abilities: {0: "Bright Wings", H: "Rivalry"},
		heightm: 1,
		weightkg: 28.4,
		color: "Yellow",
		prevo: "Silcoon",
	...
	dustox: {
		...
		name: "Dustox",
		types: ["Bug", "Poison"],
		baseStats: {hp: 70, atk: 50, def: 100, spa: 50, spd: 120, spe: 65},
		abilities: {0: "Grudge Dust", H: "Compound Eyes"},
		heightm: 1.2,
		weightkg: 31.6,
		color: "Green",
		prevo: "Cascoon",
	...
	ludicolo: {
		...
		name: "Ludicolo",
		types: ["Water", "Grass"],
		baseStats: {hp: 80, atk: 80, def: 90, spa: 100, spd: 120, spe: 70},
	...
	shiftry: {
		...
		name: "Shiftry",
		types: ["Grass", "Dark"],
		baseStats: {hp: 100, atk: 120, def: 60, spa: 110, spd: 60, spe: 90},
		abilities: {0: "Chlorophyll", 1: "Schemer", H: "Pickpocket"},
		heightm: 1.3,
		weightkg: 59.6,
		color: "Brown",
		prevo: "Nuzleaf",
	...
	swellow: {
		...
		name: "Swellow",
		types: ["Normal", "Flying"],
		baseStats: {hp: 70, atk: 95, def: 60, spa: 85, spd: 50, spe: 155},
		abilities: {0: "Guts", H: "Scrappy"},
		heightm: 0.7,
		weightkg: 19.8,
		color: "Blue",
	...
	pelipper: {
		...
		name: "Pelipper",
		types: ["Water", "Flying"],
		baseStats: {hp: 70, atk: 50, def: 120, spa: 95, spd: 80, spe: 65},
		abilities: {0: "Stock Stasher", 1: "Drizzle", H: "Rain Dish"},
		heightm: 1.2,
		weightkg: 28,
		color: "Yellow",
		prevo: "Wingull",
	...
	gardevoir: {
		...
		name: "Gardevoir",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 78, atk: 75, def: 65, spa: 145, spd: 135, spe: 80},
		abilities: {0: "Synchronize", 1: "Trace", H: "Psychic Lock"},
		heightm: 1.6,
		weightkg: 48.4,
		color: "White",
		prevo: "Kirlia",
	...
	gardevoirmega: {
		...
		forme: "Mega",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 78, atk: 85, def: 65, spa: 185, spd: 145, spe: 100},
	...
	masquerain: {
		...
		name: "Masquerain",
		types: ["Bug", "Flying"],
		baseStats: {hp: 80, atk: 60, def: 72, spa: 120, spd: 92, spe: 90},
		abilities: {0: "Intimidate", H: "Aqua Glide"},
		heightm: 0.8,
		weightkg: 3.6,
		color: "Blue",
		prevo: "Surskit",
	...
	breloom: {
		...
		baseStats: {hp: 70, atk: 140, def: 90, spa: 70, spd: 70, spe: 80},
	...
	vigoroth: {
		...
		name: "Vigoroth",
		types: ["Normal"],
		baseStats: {hp: 90, atk: 90, def: 90, spa: 55, spd: 55, spe: 100},
	...
	slaking: {
		...
		name: "Slaking",
		types: ["Normal"],
		baseStats: {hp: 170, atk: 170, def: 110, spa: 95, spd: 75, spe: 110},
		abilities: {0: "Truant"},
		heightm: 2,
		weightkg: 130.5,
		color: "Brown",
	...
	ninjask: {
		...
		name: "Ninjask",
		types: ["Bug", "Flying"],
		baseStats: {hp: 61, atk: 110, def: 55, spa: 50, spd: 60, spe: 180},
	...
	shedinja: {
		...
		types: ["Bug", "Ghost"],
		gender: "N",
		baseStats: {hp: 1, atk: 110, def: 45, spa: 40, spd: 30, spe: 70},
		maxHP: 1,
	...
	exploud: {
		...
		name: "Exploud",
		types: ["Normal"],
		baseStats: {hp: 124, atk: 111, def: 63, spa: 111, spd: 73, spe: 68},
		abilities: {0: "Soundproof",1: "Deafening", H: "Scrappy"},
		heightm: 1.5,
		weightkg: 84,
		color: "Blue",
		prevo: "Loudred",
	...
	hariyama: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 184, atk: 140, def: 60, spa: 40, spd: 60, spe: 50},
		abilities: {0: "Thick Fat", 1: "Guts", H: "Sheer Force"},
		heightm: 2.3,
		weightkg: 253.8,
		color: "Brown",
	...
	nosepass: {
		...
		name: "Nosepass",
		types: ["Rock"],
		baseStats: {hp: 30, atk: 55, def: 155, spa: 55, spd: 110, spe: 30},
		abilities: {0: "Sturdy", 1: "Magnet Pull", H: "Pull Away"},
		heightm: 1,
		weightkg: 97,
		color: "Gray",
		evos: ["Probopass"],
	...
	delcatty: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 80, atk: 95, def: 75, spa: 85, spd: 65, spe: 100},
		abilities: {0: "Cute Charm", 1: "Normalize", H: "Wonder Skin"},
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
	...
	sableye: {
		...
		name: "Sableye",
		types: ["Dark", "Ghost"],
		baseStats: {hp: 50, atk: 85, def: 95, spa: 85, spd: 85, spe: 50},
	...
	sableyemega: {
		...
		forme: "Mega",
		types: ["Dark", "Ghost"],
		baseStats: {hp: 50, atk: 95, def: 135, spa: 95, spd: 125, spe: 20},
	...
	mawile: {
		...
		name: "Mawile",
		types: ["Steel", "Fairy"],
		baseStats: {hp: 50, atk: 115, def: 95, spa: 55, spd: 75, spe: 60},
		abilities: {0: "Gnaw Maw", 1: "Intimidate", H: "Sheer Force"},
		heightm: 0.6,
		weightkg: 11.5,
		color: "Black",
		eggGroups: ["Field", "Fairy"],
	...
	mawilemega: {
		...
		forme: "Mega",
		types: ["Steel", "Fairy"],
		baseStats: {hp: 50, atk: 105, def: 135, spa: 55, spd: 105, spe: 50},
	...
	aggron: {
		...
		name: "Aggron",
		types: ["Steel", "Rock"],
		baseStats: {hp: 80, atk: 130, def: 190, spa: 60, spd: 70, spe: 60},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Heavy Metal"},
		heightm: 2.1,
		weightkg: 360,
		color: "Gray",
	...
	aggronmega: {
		...
		forme: "Mega",
		types: ["Steel"],
		baseStats: {hp: 80, atk: 150, def: 230, spa: 60, spd: 80, spe: 50},
		abilities: {0: "Filter"},
		heightm: 2.2,
		weightkg: 395,
		color: "Gray",
	...
	medicham: {
		...
		name: "Medicham",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 70, atk: 70, def: 85, spa: 70, spd: 85, spe: 90},
		abilities: {0: "Pure Power", H: "Magic Focus"},
		heightm: 1.3,
		weightkg: 31.5,
		color: "Red",
		prevo: "Meditite",
	...
	medichammega: {
		...
		forme: "Mega",
		types: ["Fighting", "Psychic"],
		baseStats: {hp: 70, atk: 100, def: 85, spa: 90, spd: 85, spe: 100},
	...
	manectric: {
		...
		name: "Manectric",
		types: ["Electric"],
		baseStats: {hp: 70, atk: 105, def: 60, spa: 115, spd: 60, spe: 125},
		abilities: {0: "Charge Rush", 1: "Lightning Rod", H: "Minus"},
		heightm: 1.5,
		weightkg: 40.2,
		color: "Yellow",
		prevo: "Electrike",
	...
	plusle: {
		...
		name: "Plusle",
		types: ["Electric"],
		baseStats: {hp: 60, atk: 60, def: 40, spa: 105, spd: 85, spe: 115},
	...
	minun: {
		...
		name: "Minun",
		types: ["Electric"],
		baseStats: {hp: 60, atk: 40, def: 60, spa: 85, spd: 105, spe: 115},
	...
	volbeat: {
		...
		types: ["Bug"],
		gender: "M",
		baseStats: {hp: 75, atk: 83, def: 85, spa: 47, spd: 105, spe: 95},
		abilities: {0: "Illuminate", 1: "Blinding", H: "Prankster"},
		heightm: 0.7,
		weightkg: 17.7,
		color: "Gray",
	...
	illumise: {
		...
		types: ["Bug"],
		gender: "F",
		baseStats: {hp: 75, atk: 47, def: 85, spa: 83, spd: 105, spe: 95},
		abilities: {0: "Screen Cleaner", 1: "Tinted Lens", H: "Prankster"},
		heightm: 0.6,
		weightkg: 17.7,
		color: "Purple",
		eggGroups: ["Bug", "Human-Like"],
	...
	roselia: {
		...
		name: "Roselia",
		types: ["Grass", "Poison"],
		baseStats: {hp: 60, atk: 70, def: 45, spa: 110, spd: 100, spe: 75},
		abilities: {0: "Natural Cure", 1: "Poison Point", H: "Thorn Trapper"},
		heightm: 0.3,
		weightkg: 2,
		color: "Green",
		prevo: "Budew",
	...
	swalot: {
		...
		abilities: {0: "Liquid Ooze", 1: "Stock Stasher", H: "Gluttony"},
		heightm: 1.7,
		weightkg: 80,
		color: "Purple",
		prevo: "Gulpin",
	...
	sharpedo: {
		...
		name: "Sharpedo",
		types: ["Water", "Dark"],
		baseStats: {hp: 70, atk: 140, def: 40, spa: 115, spd: 40, spe: 115},
		abilities: {0: "Rough Skin", H: "Speed Boost"},
		heightm: 1.8,
		weightkg: 88.8,
		color: "Blue",
	...
	sharpedomega: {
		...
		forme: "Mega",
		types: ["Water", "Dark"],
		baseStats: {hp: 70, atk: 160, def: 70, spa: 130, spd: 65, spe: 125},
	...
	wailord: {
		...
		name: "Wailord",
		types: ["Water"],
		baseStats: {hp: 200, atk: 100, def: 45, spa: 100, spd: 45, spe: 70},
		abilities: {0: "Water Veil", 1: "Oblivious", H: "Colossal Drench"},
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
		prevo: "Wailmer",
	...
	camerupt: {
		...
		name: "Camerupt",
		types: ["Fire", "Ground"],
		baseStats: {hp: 80, atk: 110, def: 80, spa: 125, spd: 85, spe: 40},
		abilities: {0: "Magma Burst", 1: "Solid Rock", H: "Anger Point"},
		heightm: 1.9,
		weightkg: 220,
		color: "Red",
		prevo: "Numel",
	...
	cameruptmega: {
		...
		forme: "Mega",
		types: ["Fire", "Ground"],
		baseStats: {hp: 80, atk: 140, def: 100, spa: 165, spd: 105, spe: 20},
	...
	torkoal: {
		...
		name: "Torkoal",
		types: ["Fire"],
		baseStats: {hp: 70, atk: 95, def: 170, spa: 95, spd: 80, spe: 20},
		abilities: {0: "White Smoke", 1: "Drought", H: "Pollution"},
		heightm: 0.5,
		weightkg: 80.4,
		color: "Brown",
		eggGroups: ["Field"],
	...
	grumpig: {
		...
		name: "Grumpig",
		types: ["Psychic"],
		baseStats: {hp: 90, atk: 85, def: 75, spa: 100, spd: 120, spe: 90},
		abilities: {0: "Thick Fat", 1: "Risk Taker", H: "Gluttony"},
		heightm: 0.9,
		weightkg: 71.5,
		color: "Purple",
		prevo: "Spoink",
	...
	spinda: {
		...
		abilities: {0: "Own Tempo", 1: "Trippy Stance", H: "Contrary"},
		heightm: 1.1,
		weightkg: 5,
		color: "Brown",
	...
	flygon: {
		...
		name: "Flygon",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 90, atk: 110, def: 90, spa: 90, spd: 90, spe: 110},
		abilities: {0: "Levitate", 1: "Sky Scales"},
		heightm: 2,
		weightkg: 82,
		color: "Green",
		prevo: "Vibrava",
	...
	cacturne: {
		...
		name: "Cacturne",
		types: ["Grass", "Dark"],
		baseStats: {hp: 70, atk: 135, def: 70, spa: 135, spd: 70, spe: 55},
		abilities: {0: "Sand Veil", H: "Scarecrow"},
		heightm: 1.3,
		weightkg: 77.4,
		color: "Green",
		prevo: "Cacnea",
	...
	altaria: {
		...
		name: "Altaria",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 85, atk: 90, def: 90, spa: 90, spd: 115, spe: 80},
		abilities: {0: "Natural Cure", H: "Clear Clouds"},
		heightm: 1.1,
		weightkg: 20.6,
		color: "Blue",
		prevo: "Swablu",
	...
	altariamega: {
		...
		forme: "Mega",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 85, atk: 120, def: 110, spa: 120, spd: 125, spe: 80},
		abilities: {0: "Pixilate"},
		heightm: 1.5,
		weightkg: 20.6,
		color: "Blue",
	...
	zangoose: {
		...
		name: "Zangoose",
		types: ["Normal"],
		baseStats: {hp: 83, atk: 135, def: 70, spa: 60, spd: 70, spe: 100},
	...
	seviper: {
		...
		name: "Seviper",
		types: ["Poison"],
		baseStats: {hp: 83, atk: 120, def: 70, spa: 120, spd: 70, spe: 85},
		abilities: {0: "Merciless", H: "Infiltrator"},
		heightm: 2.7,
		weightkg: 52.5,
		color: "Black",
	...
	lunatone: {
		...
		types: ["Rock", "Psychic"],
		gender: "N",
		baseStats: {hp: 100, atk: 55, def: 75, spa: 115, spd: 95, spe: 80},
		abilities: {0: "Levitate", 1: "Gravitational Pull"},
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
		eggGroups: ["Mineral"],
	...
	solrock: {
		...
		types: ["Rock", "Psychic"],
		gender: "N",
		baseStats: {hp: 100, atk: 115, def: 95, spa: 55, spd: 75, spe: 80},
		abilities: {0: "Levitate", 1: "Gravitational Pull"},
		heightm: 1.2,
		weightkg: 154,
		color: "Red",
	...
	whiscash: {
		...
		name: "Whiscash",
		types: ["Water", "Ground"],
		baseStats: {hp: 130, atk: 98, def: 83, spa: 86, spd: 71, spe: 60},
		abilities: {0: "Multiscale", 1: "Anticipation", H: "Hydration"},
		heightm: 0.9,
		weightkg: 23.6,
		color: "Blue",
		prevo: "Barboach",
	...
	crawdaunt: {
		...
		name: "Crawdaunt",
		types: ["Water", "Dark"],
		baseStats: {hp: 63, atk: 150, def: 95, spa: 100, spd: 65, spe: 55},
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Adaptability"},
		heightm: 1.1,
		weightkg: 32.8,
		color: "Red",
	...
	claydol: {
		...
		types: ["Ground", "Psychic"],
		gender: "N",
		baseStats: {hp: 60, atk: 80, def: 125, spa: 80, spd: 140, spe: 75},
		abilities: {0: "Levitate", 1: "Beam Launcher"},
		heightm: 1.5,
		weightkg: 108,
		color: "Black",
		prevo: "Baltoy",
	...
	cradily: {
		...
		types: ["Rock", "Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 96, atk: 91, def: 107, spa: 91, spd: 127, spe: 43},
		abilities: {0: "Fossilize", H: "Storm Drain"},
		heightm: 1.5,
		weightkg: 60.4,
		color: "Green",
		prevo: "Lileep",
	...
	armaldo: {
		...
		types: ["Rock", "Bug"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 155, def: 110, spa: 70, spd: 90, spe: 45},
		abilities: {0: "Fossilize", H: "Swift Swim"},
		heightm: 1.5,
		weightkg: 68.2,
		color: "Gray",
		prevo: "Anorith",
	...
	milotic: {
		...
		name: "Milotic",
		types: ["Water"],
		baseStats: {hp: 105, atk: 60, def: 79, spa: 120, spd: 145, spe: 81},
		abilities: {0: "Marvel Scale", 1: "Competitive", H: "Majestic Aura"},
		heightm: 6.2,
		weightkg: 162,
		color: "Pink",
		prevo: "Feebas",
	...
	castformsunny: {
		...
		forme: "Sunny",
		types: ["Fire"],
		baseStats: {hp: 80, atk: 120, def: 70, spa: 130, spd: 70, spe: 120},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Red",
	...
	castformrainy: {
		...
		forme: "Rainy",
		types: ["Water"],
		baseStats: {hp: 80, atk: 90, def: 130, spa: 100, spd: 130, spe: 60},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "Blue",
	...
	castformsnowy: {
		...
		forme: "Snowy",
		types: ["Ice"],
		baseStats: {hp: 80, atk: 140, def: 60, spa: 150, spd: 60, spe: 100},
		abilities: {0: "Forecast"},
		heightm: 0.3,
		weightkg: 0.8,
		color: "White",
	...
	kecleon: {
		...
		name: "Kecleon",
		types: ["Normal"],
		baseStats: {hp: 70, atk: 100, def: 80, spa: 70, spd: 140, spe: 40},
		abilities: {0: "Color Change", H: "Camoflauge"},
		heightm: 1,
		weightkg: 22,
		color: "Green",
		eggGroups: ["Field"],
	...
	banette: {
		...
		name: "Banette",
		types: ["Ghost"],
		baseStats: {hp: 64, atk: 145, def: 75, spa: 93, spd: 73, spe: 65},
		abilities: {0: "Destiny Curse", 1: "Frisk", H: "Cursed Body"},
		heightm: 1.1,
		weightkg: 12.5,
		color: "Black",
		prevo: "Shuppet",
	...
	banettemega: {
		...
		forme: "Mega",
		types: ["Ghost"],
		baseStats: {hp: 64, atk: 185, def: 85, spa: 103, spd: 93, spe: 75},
	...
	dusclops: {
		...
		name: "Dusclops",
		types: ["Ghost"],
		baseStats: {hp: 40, atk: 80, def: 150, spa: 70, spd: 150, spe: 25},
		abilities: {0: "Pressure", H: "Cursed Grasp"},
		heightm: 1.6,
		weightkg: 30.6,
		color: "Black",
		prevo: "Duskull",
	...
	tropius: {
		...
		name: "Tropius",
		types: ["Grass", "Flying"],
		baseStats: {hp: 119, atk: 78, def: 93, spa: 82, spd: 97, spe: 51},
	...
	chimecho: {
		...
		name: "Chimecho",
		types: ["Psychic"],
		baseStats: {hp: 75, atk: 50, def: 100, spa: 105, spd: 120, spe: 65},
		abilities: {0: "Ringing Melody", 1: "Echoed Wave"},
		heightm: 0.6,
		weightkg: 1,
		color: "Blue",
		prevo: "Chingling",
	...
	absol: {
		...
		name: "Absol",
		types: ["Dark"],
		baseStats: {hp: 75, atk: 150, def: 60, spa: 95, spd: 60, spe: 85},
		abilities: {0: "Darken", 1: "Super Luck", H: "Justified"},
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	absolmega: {
		...
		forme: "Mega",
		types: ["Dark"],
		baseStats: {hp: 75, atk: 170, def: 60, spa: 135, spd: 60, spe: 125},
		abilities: {0: "Magic Bounce"},
		heightm: 1.2,
		weightkg: 49,
		color: "White",
	...
	glalie: {
		...
		abilities: {0: "Frost Belch", 1: "Ice Body", H: "Moody"},
		heightm: 1.5,
		weightkg: 256.5,
		color: "Gray",
		prevo: "Snorunt",
	...
	walrein: {
		...
		name: "Walrein",
		types: ["Ice", "Water"],
		baseStats: {hp: 130, atk: 100, def: 90, spa: 105, spd: 100, spe: 65},
		abilities: {0: "Thick Fat", 1: "Ice Body", H: "Curl Up"},
		heightm: 1.4,
		weightkg: 150.6,
		color: "Blue",
		prevo: "Sealeo",
	...
	clamperl: {
		...
		name: "Clamperl",
		types: ["Water"],
		baseStats: {hp: 45, atk: 74, def: 105, spa: 84, spd: 65, spe: 32},
	...
	huntail: {
		...
		name: "Huntail",
		types: ["Water"],
		baseStats: {hp: 65, atk: 124, def: 125, spa: 94, spd: 85, spe: 52},
	...
	gorebyss: {
		...
		name: "Gorebyss",
		types: ["Water"],
		baseStats: {hp: 65, atk: 84, def: 125, spa: 134, spd: 85, spe: 52},
		abilities: {0: "Swift Swim", H: "Slippery"},
		heightm: 1.8,
		weightkg: 22.6,
		color: "Pink",
		prevo: "Clamperl",
	...
	relicanth: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 110, def: 150, spa: 45, spd: 65, spe: 65},
		abilities: {0: "Rock Down", 1: "Rock Head", H: "Sturdy"},
		heightm: 1,
		weightkg: 23.4,
		color: "Gray",
		eggGroups: ["Water 1", "Water 2"],
	...
	luvdisc: {
		...
		types: ["Water"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 63, atk: 40, def: 65, spa: 50, spd: 85, spe: 127},
		abilities: {0: "Swift Swim", H: "Pixie Power"},
		heightm: 0.6,
		weightkg: 8.7,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	salamence: {
		...
		name: "Salamence",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 95, atk: 155, def: 80, spa: 120, spd: 80, spe: 100},
	...
	salamencemega: {
		...
		forme: "Mega",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 95, atk: 165, def: 130, spa: 130, spd: 90, spe: 120},
		abilities: {0: "Aerilate"},
		heightm: 1.8,
		weightkg: 112.6,
		color: "Blue",
	...
	metagross: {
		...
		types: ["Steel", "Psychic"],
		gender: "N",
		baseStats: {hp: 80, atk: 145, def: 140, spa: 95, spd: 100, spe: 70},
		abilities: {0: "Clear Body", H: "Target Spot"},
		heightm: 1.6,
		weightkg: 550,
		color: "Blue",
		prevo: "Metang",
	...
	metagrossmega: {
		...
		types: ["Steel", "Psychic"],
		gender: "N",
		baseStats: {hp: 80, atk: 155, def: 160, spa: 105, spd: 120, spe: 110},
		abilities: {0: "Tough Claws"},
		heightm: 2.5,
		weightkg: 942.9,
		color: "Blue",
	...
	regirock: {
		...
		types: ["Rock"],
		gender: "N",
		baseStats: {hp: 80, atk: 110, def: 220, spa: 50, spd: 110, spe: 50},
		abilities: {0: "Rugged Body", H: "Sturdy"},
		heightm: 1.7,
		weightkg: 230,
		color: "Brown",
		tags: ["Sub-Legendary"],
	...
	regice: {
		...
		types: ["Ice"],
		gender: "N",
		baseStats: {hp: 80, atk: 50, def: 110, spa: 110, spd: 220, spe: 50},
		abilities: {0: "Freezing Body", H: "Ice Body"},
		heightm: 1.8,
		weightkg: 175,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	registeel: {
		...
		types: ["Steel"],
		gender: "N",
		baseStats: {hp: 80, atk: 75, def: 170, spa: 75, spd: 170, spe: 50},
		abilities: {0: "Flawless Body", H: "Light Metal"},
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		tags: ["Sub-Legendary"],
	...
	torterra: {
		...
		types: ["Grass", "Ground"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 129, def: 125, spa: 75, spd: 95, spe: 56},
		abilities: {0: "Land Planter", H: "Shell Armor"},
		heightm: 2.2,
		weightkg: 310,
		color: "Green",
		prevo: "Grotle",
	...
	infernape: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 76, atk: 124, def: 71, spa: 124, spd: 71, spe: 128},
		abilities: {0: "Martial Artist", H: "Iron Fist"},
		heightm: 1.2,
		weightkg: 55,
		color: "Brown",
		prevo: "Monferno",
	...
	empoleon: {
		...
		types: ["Water", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 84, atk: 96, def: 98, spa: 131, spd: 121, spe: 60},
		abilities: {0: "Supreme Overlord", H: "Defiant"},
		heightm: 1.7,
		weightkg: 84.5,
		color: "Blue",
		prevo: "Prinplup",
	...
	staraptor: {
		...
		name: "Staraptor",
		types: ["Normal", "Flying"],
		baseStats: {hp: 85, atk: 140, def: 80, spa: 50, spd: 70, spe: 120},
		abilities: {0: "Intimidate", H: "Reckless"},
		heightm: 1.2,
		weightkg: 24.9,
		color: "Brown",
	...
	bibarel: {
		...
		name: "Bibarel",
		types: ["Normal", "Water"],
		baseStats: {hp: 99, atk: 95, def: 80, spa: 55, spd: 80, spe: 71},
		abilities: {0: "Simple", 1: "Unaware", H: "Moody"},
		heightm: 1,
		weightkg: 31.5,
		color: "Brown",
	...
	kricketune: {
		...
		name: "Kricketune",
		types: ["Bug"],
		baseStats: {hp: 77, atk: 95, def: 71, spa: 95, spd: 71, spe: 75},
		abilities: {0: "Ringing Melody", H: "Technician"},
		heightm: 1,
		weightkg: 25.5,
		color: "Red",
		prevo: "Kricketot",
	...
	luxray: {
		...
		name: "Luxray",
		types: ["Electric"],
		baseStats: {hp: 90, atk: 140, def: 79, spa: 105, spd: 79, spe: 90},
		abilities: {0: "Rivalry", 1: "Intimidate", H: "Guts"},
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
	...
	roserade: {
		...
		name: "Roserade",
		types: ["Grass", "Poison"],
		baseStats: {hp: 70, atk: 80, def: 65, spa: 145, spd: 115, spe: 100},
		abilities: {0: "Thorn Trapper", 1: "Poison Point", H: "Technician"},
		heightm: 0.9,
		weightkg: 14.5,
		color: "Green",
		prevo: "Roselia",
	...
	rampardos: {
		...
		types: ["Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 107, atk: 195, def: 70, spa: 65, spd: 50, spe: 68},
		abilities: {0: "Mold Breaker", 1: "Unstoppable", H: "Sheer Force"},
		heightm: 1.6,
		weightkg: 102.5,
		color: "Blue",
		prevo: "Cranidos",
	...
	bastiodon: {
		...
		types: ["Rock", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 72, def: 188, spa: 47, spd: 158, spe: 30},
		abilities: {0: "Sturdy", 1: "Immovable", H: "Soundproof"},
		heightm: 1.3,
		weightkg: 149.5,
		color: "Gray",
		prevo: "Shieldon",
	...
	wormadam: {
		...
		types: ["Bug", "Grass"],
		gender: "F",
		baseStats: {hp: 70, atk: 59, def: 105, spa: 89, spd: 125, spe: 36},
		abilities: {0: "Plant Cloak", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Green",
		prevo: "Burmy",
	...
	wormadamsandy: {
		...
		types: ["Bug", "Ground"],
		gender: "F",
		baseStats: {hp: 70, atk: 89, def: 125, spa: 59, spd: 105, spe: 36},
		abilities: {0: "Sand Cloak", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Brown",
		prevo: "Burmy",
	...
	wormadamtrash: {
		...
		types: ["Bug", "Steel"],
		gender: "F",
		baseStats: {hp: 70, atk: 79, def: 115, spa: 79, spd: 115, spe: 26},
		abilities: {0: "Trash Cloak", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Red",
		prevo: "Burmy",
	...
	mothim: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 114, def: 50, spa: 114, spd: 50, spe: 86},
		abilities: {0: "Grudge Dust", H: "Tinted Lens"},
		heightm: 0.9,
		weightkg: 23.3,
		color: "Yellow",
		prevo: "Burmy",
	...
	vespiquen: {
		...
		types: ["Bug", "Flying"],
		gender: "F",
		baseStats: {hp: 70, atk: 90, def: 122, spa: 90, spd: 122, spe: 40},
		abilities: {0: "Pressure", H: "Queen Bee"},
		heightm: 1.2,
		weightkg: 38.5,
		color: "Yellow",
		prevo: "Combee",
	...
	floatzel: {
		...
		name: "Floatzel",
		types: ["Water"],
		baseStats: {hp: 95, atk: 115, def: 65, spa: 95, spd: 50, spe: 135},
		abilities: {0: "Swift Swim", H: "Water Veil"},
		heightm: 1.1,
		weightkg: 33.5,
		color: "Brown",
	...
	cherrim: {
		...
		baseForme: "Overcast",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 60, def: 100, spa: 97, spd: 108, spe: 85},
	...
	cherrimsunshine: {
		...
		forme: "Sunshine",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 100, def: 80, spa: 137, spd: 88, spe: 125},
		abilities: {0: "Flower Gift"},
		heightm: 0.5,
		weightkg: 9.3,
		color: "Pink",
	...
	gastrodon: {
		...
		baseForme: "West",
		types: ["Water", "Ground"],
		baseStats: {hp: 131, atk: 93, def: 78, spa: 102, spd: 92, spe: 39},
		abilities: {0: "Sticky Goo", 1: "Storm Drain", H: "Sand Force"},
		heightm: 0.9,
		weightkg: 29.9,
		color: "Purple",
		prevo: "Shellos",
	...
	ambipom: {
		...
		name: "Ambipom",
		types: ["Normal"],
		baseStats: {hp: 85, atk: 120, def: 66, spa: 70, spd: 66, spe: 135},
		abilities: {0: "Technician", 1: "Scrappy", H: "Skill Link"},
		heightm: 1.2,
		weightkg: 20.3,
		color: "Purple",
		prevo: "Aipom",
	...
	drifblim: {
		...
		name: "Drifblim",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 180, atk: 80, def: 44, spa: 100, spd: 54, spe: 100},
		abilities: {0: "Aftermath", 1: "Unburden", H: "Flare Boost"},
		heightm: 1.2,
		weightkg: 15,
		color: "Purple",
	...
	lopunny: {
		...
		name: "Lopunny",
		types: ["Normal"],
		baseStats: {hp: 65, atk: 96, def: 94, spa: 54, spd: 106, spe: 125},
	...
	lopunnymega: {
		...
		baseStats: {hp: 65, atk: 146, def: 94, spa: 54, spd: 96, spe: 145},
		abilities: {0: "Scrappy"},
		heightm: 1.3,
		weightkg: 28.3,
		color: "Brown",
	...
	mismagius: {
		...
		abilities: {0: "Spellcaster", H: "Cursed Voice"},
		heightm: 0.9,
		weightkg: 4.4,
		color: "Purple",
		prevo: "Misdreavus",
	...
	honchkrow: {
		...
		name: "Honchkrow",
		types: ["Dark", "Flying"],
		baseStats: {hp: 120, atk: 145, def: 62, spa: 105, spd: 62, spe: 71},
	...
	purugly: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 71, atk: 92, def: 64, spa: 64, spd: 59, spe: 132},
		abilities: {0: "Thick Fat", 1: "Fur Coat", H: "Defiant"},
		heightm: 1,
		weightkg: 43.8,
		color: "Gray",
		prevo: "Glameow",
	...
	skuntank: {
		...
		name: "Skuntank",
		types: ["Poison", "Dark"],
		baseStats: {hp: 113, atk: 113, def: 67, spa: 91, spd: 61, spe: 94},
		abilities: {0: "Stench", 1: "Aftermath", H: "Stakeout"},
		heightm: 1,
		weightkg: 38,
		color: "Purple",
		prevo: "Stunky",
	...
	bronzong: {
		...
		types: ["Steel", "Psychic"],
		gender: "N",
		baseStats: {hp: 67, atk: 109, def: 136, spa: 79, spd: 136, spe: 33},
		abilities: {0: "Levitate", 1: "Weather Chime", H: "Heavy Metal"},
		heightm: 1.3,
		weightkg: 187,
		color: "Green",
		prevo: "Bronzor",
	...
	chatot: {
		...
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Ringing Melody"},
		heightm: 0.5,
		weightkg: 1.9,
		color: "Black",
		eggGroups: ["Flying"],
	...
	spiritomb: {
		...
		abilities: {0: "Soul Absorb", H: "Infiltrator"},
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	garchompmega: {
		...
		forme: "Mega",
		types: ["Dragon", "Ground"],
		baseStats: {hp: 108, atk: 180, def: 125, spa: 130, spd: 95, spe: 92},
		abilities: {0: "Sand Force"},
		heightm: 1.9,
		weightkg: 95,
		color: "Blue",
	...
	lucario: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 130, def: 70, spa: 135, spd: 70, spe: 100},
	...
	hippowdon: {
		...
		name: "Hippowdon",
		types: ["Ground"],
		baseStats: {hp: 128, atk: 122, def: 138, spa: 68, spd: 82, spe: 47},
		abilities: {0: "Sand Stream", H: "Sand Force"},
		heightm: 2,
		weightkg: 300,
		color: "Brown",
	...
	drapion: {
		...
		name: "Drapion",
		types: ["Poison", "Dark"],
		baseStats: {hp: 80, atk: 110, def: 120, spa: 60, spd: 85, spe: 105},
		abilities: {0: "Toxic Rush", 1: "Sniper", H: "Merciless"},
		heightm: 1.3,
		weightkg: 61.5,
		color: "Purple",
		prevo: "Skorupi",
	...
	toxicroak: {
		...
		name: "Toxicroak",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 93, atk: 126, def: 65, spa: 96, spd: 65, spe: 105},
		abilities: {0: "Lethal Claw", 1: "Dry Skin", H: "Poison Touch"},
		heightm: 1.3,
		weightkg: 44.4,
		color: "Blue",
		prevo: "Croagunk",
	...
	carnivine: {
		...
		name: "Carnivine",
		types: ["Grass"],
		baseStats: {hp: 84, atk: 130, def: 82, spa: 90, spd: 82, spe: 46},
		abilities: {0: "Levitate", 1: "Flytrap", H: "Thorn Trapper"},
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
		eggGroups: ["Grass"],
	...
	lumineon: {
		...
		name: "Lumineon",
		types: ["Water"],
		baseStats: {hp: 79, atk: 89, def: 76, spa: 89, spd: 96, spe: 111},
		abilities: {0: "Swift Swim", 1: "Storm Drain", H: "Path Lighter"},
		heightm: 1.2,
		weightkg: 24,
		color: "Blue",
		prevo: "Finneon",
	...
	abomasnow: {
		...
		name: "Abomasnow",
		types: ["Grass", "Ice"],
		baseStats: {hp: 90, atk: 112, def: 85, spa: 112, spd: 95, spe: 60},
		abilities: {0: "Snow Warning", H: "Temperature Shock"},
		heightm: 2.2,
		weightkg: 135.5,
		color: "White",
		prevo: "Snover",
	...
	abomasnowmega: {
		...
		forme: "Mega",
		types: ["Grass", "Ice"],
		baseStats: {hp: 90, atk: 152, def: 115, spa: 152, spd: 115, spe: 30},
	...
	weavile: {
		...
		name: "Weavile",
		types: ["Dark", "Ice"],
		baseStats: {hp: 70, atk: 140, def: 75, spa: 45, spd: 95, spe: 145},
		abilities: {0: "Super Luck", H: "Pickpocket"},
		heightm: 1.1,
		weightkg: 34,
		color: "Black",
		prevo: "Sneasel",
	...
	magnezone: {
		...
		types: ["Electric", "Steel"],
		gender: "N",
		baseStats: {hp: 70, atk: 70, def: 135, spa: 150, spd: 100, spe: 60},
		abilities: {0: "Magnet Pull", 1: "Pull Away", H: "Analytic"},
		heightm: 1.2,
		weightkg: 180,
		color: "Gray",
		prevo: "Magneton",
	...
	lickilicky: {
		...
		name: "Lickilicky",
		types: ["Normal"],
		baseStats: {hp: 140, atk: 95, def: 105, spa: 80, spd: 105, spe: 50},
		abilities: {0: "Own Tempo", 1: "Squelch", H: "Cloud Nine"},
		heightm: 1.7,
		weightkg: 140,
		color: "Pink",
	...
	rhyperior: {
		...
		name: "Rhyperior",
		types: ["Ground", "Rock"],
		baseStats: {hp: 135, atk: 160, def: 140, spa: 55, spd: 65, spe: 40},
		abilities: {0: "Relentless", 1: "Solid Rock", H: "Reckless"},
		heightm: 2.4,
		weightkg: 282.8,
		color: "Gray",
		prevo: "Rhydon",
	...
	tangrowth: {
		...
		name: "Tangrowth",
		types: ["Grass"],
		baseStats: {hp: 110, atk: 110, def: 135, spa: 130, spd: 50, spe: 50},
		abilities: {0: "Chlorophyll", 1: "Thorn Trapper", H: "Regenerator"},
		heightm: 2,
		weightkg: 128.6,
		color: "Blue",
		prevo: "Tangela",
	...
	electivire: {
		...
		types: ["Electric"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 85, atk: 143, def: 67, spa: 105, spd: 85, spe: 115},
		abilities: {0: "Motor Drive", H: "Amplify"},
		heightm: 1.8,
		weightkg: 138.6,
		color: "Yellow",
		prevo: "Electabuzz",
	...
	magmortar: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 85, atk: 105, def: 67, spa: 145, spd: 105, spe: 93},
		abilities: {0: "Flame Body", H: "Fire Maw"},
		heightm: 1.6,
		weightkg: 68,
		color: "Red",
	...
	togekiss: {
		...
		types: ["Fairy", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 50, def: 95, spa: 140, spd: 135, spe: 90},
		abilities: {0: "Hustle", 1: "Serene Grace", H: "Wonder Field"},
		heightm: 1.5,
		weightkg: 38,
		color: "White",
		prevo: "Togetic",
	...
	yanmega: {
		...
		name: "Yanmega",
		types: ["Bug", "Flying"],
		baseStats: {hp: 96, atk: 76, def: 96, spa: 136, spd: 66, spe: 105},
	...
	leafeon: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 130, def: 150, spa: 60, spd: 65, spe: 105},
		abilities: {0: "Leaf Guard",1: "Adaptability", H: "Chlorophyll"},
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
		prevo: "Eevee",
	...
	glaceon: {
		...
		types: ["Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 60, def: 130, spa: 150, spd: 105, spe: 65},
		abilities: {0: "Snow Cloak", 1: "Adaptability", H: "Ice Body"},
		heightm: 0.8,
		weightkg: 25.9,
		color: "Blue",
		prevo: "Eevee",
	...
	gliscor: {
		...
		name: "Gliscor",
		types: ["Ground", "Flying"],
		baseStats: {hp: 75, atk: 115, def: 135, spa: 45, spd: 85, spe: 95},
	...
	mamoswine: {
		...
		name: "Mamoswine",
		types: ["Ice", "Ground"],
		baseStats: {hp: 130, atk: 150, def: 90, spa: 70, spd: 60, spe: 90},
		abilities: {0: "Oblivious", 1: "Snow Cloak", H: "Thick Fat"},
		heightm: 2.5,
		weightkg: 291,
		color: "Brown",
	...
	porygonz: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 85, atk: 80, def: 70, spa: 165, spd: 85, spe: 100},
		abilities: {0: "Adaptability", 1: "Download", H: "Glitchy Surge"},
		heightm: 0.9,
		weightkg: 34,
		color: "Red",
		prevo: "Porygon2",
	...
	gallade: {
		...
		types: ["Psychic", "Fighting"],
		gender: "M",
		baseStats: {hp: 78, atk: 145, def: 65, spa: 65, spd: 135, spe: 90},
	...
	probopass: {
		...
		name: "Probopass",
		types: ["Rock", "Steel"],
		baseStats: {hp: 70, atk: 55, def: 155, spa: 95, spd: 170, spe: 40},
		abilities: {0: "Pull Away", 1: "Magnet Pull", H: "Sand Force"},
		heightm: 1.4,
		weightkg: 340,
		color: "Gray",
		prevo: "Nosepass",
	...
	dusknoir: {
		...
		abilities: {0: "Cursed Grasp", H: "Frisk"},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Black",
		prevo: "Dusclops",
	...
	froslass: {
		...
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: {hp: 70, atk: 80, def: 80, spa: 100, spd: 80, spe: 130},
		abilities: {0: "Spellcaster", H: "Cursed Body"},
		heightm: 1.3,
		weightkg: 26.6,
		color: "White",
		prevo: "Snorunt",
	...
	rotom: {
		...
		gender: "N",
		baseStats: {hp: 50, atk: 50, def: 87, spa: 115, spd: 87, spe: 111},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotomheat: {
		...
		types: ["Electric", "Fire"],
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 127, spa: 125, spd: 117, spe: 96},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotomwash: {
		...
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 127, spa: 115, spd: 137, spe: 86},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotomfrost: {
		...
		types: ["Electric", "Ice"],
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 137, spa: 125, spd: 127, spe: 76},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotomfan: {
		...
		types: ["Electric", "Flying"],
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 117, spa: 125, spd: 117, spe: 106},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	rotommow: {
		...
		types: ["Electric", "Grass"],
		gender: "N",
		baseStats: {hp: 50, atk: 65, def: 107, spa: 135, spd: 127, spe: 96},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	uxie: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 75, atk: 75, def: 140, spa: 75, spd: 140, spe: 105},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Yellow",
	...
	mesprit: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 90, atk: 115, def: 105, spa: 115, spd: 105, spe: 80},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Pink",
	...
	azelf: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 75, atk: 135, def: 70, spa: 135, spd: 70, spe: 125},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 0.3,
		color: "Blue",
	...
	regigigas: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 120, atk: 180, def: 120, spa: 80, spd: 120, spe: 110},
	...
	serperior: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 85, def: 105, spa: 75, spd: 105, spe: 133},
		abilities: {0: "Thorn Trapper", H: "Contrary"},
		heightm: 3.3,
		weightkg: 63,
		color: "Green",
		prevo: "Servine",
	...
	emboar: {
		...
		types: ["Fire", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 130, atk: 133, def: 75, spa: 110, spd: 75, spe: 65},
		abilities: {0: "Thick Fat", H: "Reckless"},
		heightm: 1.6,
		weightkg: 150,
		color: "Red",
		prevo: "Pignite",
	...
	samurott: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 120, def: 95, spa: 118, spd: 70, spe: 80},
		abilities: {0: "Sharpness", H: "Shell Armor"},
		heightm: 1.5,
		weightkg: 94.6,
		color: "Blue",
		prevo: "Dewott",
	...
	watchog: {
		...
		name: "Watchog",
		types: ["Normal"],
		baseStats: {hp: 80, atk: 105, def: 89, spa: 60, spd: 89, spe: 77},
		abilities: {0: "Path Lighter", 1: "Keen Eye", H: "Analytic"},
		heightm: 1.1,
		weightkg: 27,
		color: "Brown",
		prevo: "Patrat",
	...
	stoutland: {
		...
		name: "Stoutland",
		types: ["Normal"],
		baseStats: {hp: 95, atk: 130, def: 100, spa: 45, spd: 100, spe: 90},
		abilities: {0: "Intimidate", 1: "Sand Rush", H: "Scrappy"},
		heightm: 1.2,
		weightkg: 61,
		color: "Gray",
	...
	liepard: {
		...
		name: "Liepard",
		types: ["Dark"],
		baseStats: {hp: 64, atk: 108, def: 50, spa: 108, spd: 50, spe: 126},
		abilities: {0: "Pester", 1: "Unburden", H: "Prankster"},
		heightm: 1.1,
		weightkg: 37.5,
		color: "Purple",
		prevo: "Purrloin",
	...
	simisage: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 128, def: 73, spa: 108, spd: 73, spe: 101},
		abilities: {0: "Gluttony", H: "Sage Surge"},
		heightm: 1.1,
		weightkg: 30.5,
		color: "Green",
		prevo: "Pansage",
	...
	simisear: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 108, def: 83, spa: 108, spd: 83, spe: 101},
		abilities: {0: "Gluttony", H: "Sear Surge"},
		heightm: 1,
		weightkg: 28,
		color: "Red",
		prevo: "Pansear",
	...
	simipour: {
		...
		types: ["Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 108, def: 73, spa: 128, spd: 73, spe: 111},
		abilities: {0: "Gluttony", H: "Pour Surge"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "Panpour",
	...
	musharna: {
		...
		name: "Musharna",
		types: ["Psychic"],
		baseStats: {hp: 146, atk: 55, def: 85, spa: 127, spd: 105, spe: 29},
		abilities: {0: "Drowsy Aura", 1: "Synchronize", H: "Telepathy"},
		heightm: 1.1,
		weightkg: 60.5,
		color: "Pink",
		prevo: "Munna",
	...
	unfezant: {
		...
		name: "Unfezant",
		types: ["Normal", "Flying"],
		baseStats: {hp: 90, atk: 125, def: 90, spa: 65, spd: 65, spe: 113},
		abilities: {0: "Courter", 1: "Super Luck", H: "Rivalry"},
		heightm: 1.2,
		weightkg: 29,
		color: "Gray",
		prevo: "Tranquill",
	...
	zebstrika: {
		...
		name: "Zebstrika",
		types: ["Electric"],
		baseStats: {hp: 85, atk: 110, def: 63, spa: 90, spd: 63, spe: 146},
		abilities: {0: "Lightning Rod", 1: "Motor Drive", H: "Electric Express"},
		heightm: 1.6,
		weightkg: 79.5,
		color: "Black",
		prevo: "Blitzle",
	...
	gigalith: {
		...
		name: "Gigalith",
		types: ["Rock"],
		baseStats: {hp: 85, atk: 155, def: 160, spa: 60, spd: 90, spe: 25},
		abilities: {0: "Sturdy", 1: "Sand Stream", H: "Chipped Down"},
		heightm: 1.7,
		weightkg: 260,
		color: "Blue",
		prevo: "Boldore",
	...
	swoobat: {
		...
		name: "Swoobat",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 87, atk: 57, def: 55, spa: 107, spd: 55, spe: 124},
		abilities: {0: "Moon Veil", 1: "Klutz", H: "Simple"},
		heightm: 0.9,
		weightkg: 10.5,
		color: "Blue",
		prevo: "Woobat",
	...
	excadrill: {
		...
		name: "Excadrill",
		types: ["Ground", "Steel"],
		baseStats: {hp: 120, atk: 155, def: 60, spa: 50, spd: 65, spe: 98},
		abilities: {0: "Sand Rush", 1: "Sand Force", H: "Mold Breaker"},
		heightm: 0.7,
		weightkg: 40.4,
		color: "Gray",
	...
	audino: {
		...
		name: "Audino",
		types: ["Normal"],
		baseStats: {hp: 123, atk: 60, def: 96, spa: 80, spd: 96, spe: 50},
		abilities: {0: "Healer", 1: "Regenerator", H: "Remedy"},
		heightm: 1.1,
		weightkg: 31,
		color: "Pink",
		eggGroups: ["Fairy"],
	...
	audinomega: {
		...
		forme: "Mega",
		types: ["Normal", "Fairy"],
		baseStats: {hp: 123, atk: 60, def: 136, spa: 100, spd: 136, spe: 50},
		abilities: {0: "Remedy"},
		heightm: 1.5,
		weightkg: 32,
		color: "White",
	...
	conkeldurr: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 115, atk: 160, def: 105, spa: 55, spd: 65, spe: 55},
		abilities: {0: "Guts", 1: "Sheer Force", H: "Iron Fist"},
		heightm: 1.4,
		weightkg: 87,
		color: "Brown",
	...
	seismitoad: {
		...
		name: "Seismitoad",
		types: ["Water", "Ground"],
		baseStats: {hp: 125, atk: 105, def: 85, spa: 95, spd: 85, spe: 74},
		abilities: {0: "Muddy", 1: "Poison Touch", H: "Water Absorb"},
		heightm: 1.5,
		weightkg: 62,
		color: "Blue",
		prevo: "Palpitoad",
	...
	throh: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 140, atk: 120, def: 95, spa: 30, spd: 95, spe: 45},
		abilities: {0: "Guts", 1: "Martial Artist", H: "Mold Breaker"},
		heightm: 1.3,
		weightkg: 55.5,
		color: "Red",
		eggGroups: ["Human-Like"],
	...
	sawk: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 85, atk: 135, def: 85, spa: 30, spd: 85, spe: 105},
		abilities: {0: "Sturdy", 1: "Martial Artist", H: "Mold Breaker"},
		heightm: 1.4,
		weightkg: 51,
		color: "Blue",
		eggGroups: ["Human-Like"],
	...
	leavanny: {
		...
		name: "Leavanny",
		types: ["Bug", "Grass"],
		baseStats: {hp: 85, atk: 113, def: 90, spa: 70, spd: 90, spe: 112},
		abilities: {0: "Swarm", 1: "Chlorophyll", H: "Silk Spreader"},
		heightm: 1.2,
		weightkg: 20.5,
		color: "Yellow",
		prevo: "Swadloon",
	...
	scolipede: {
		...
		name: "Scolipede",
		types: ["Bug", "Poison"],
		baseStats: {hp: 70, atk: 120, def: 109, spa: 55, spd: 69, spe: 122},
		abilities: {0: "Poison Point", 1: "Stampede", H: "Speed Boost"},
		heightm: 2.5,
		weightkg: 200.5,
		color: "Red",
		prevo: "Whirlipede",
	...
	whimsicott: {
		...
		name: "Whimsicott",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 60, atk: 67, def: 105, spa: 107, spd: 85, spe: 126},
	...
	lilligant: {
		...
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 80, atk: 60, def: 85, spa: 130, spd: 85, spe: 100},
		abilities: {0: "Chlorophyll", 1: "Own Tempo", H: "Therapuetic"},
		heightm: 1.1,
		weightkg: 16.3,
		color: "Green",
		prevo: "Petilil",
	...
	basculin: {
		...
		types: ["Water"],
		baseStats: {hp: 80, atk: 112, def: 75, spa: 90, spd: 55, spe: 108},
	...
	basculinbluestriped: {
		...
		forme: "Blue-Striped",
		types: ["Water"],
		baseStats: {hp: 80, atk: 102, def: 75, spa: 90, spd: 55, spe: 118},
	...
	krookodile: {
		...
		name: "Krookodile",
		types: ["Ground", "Dark"],
		baseStats: {hp: 105, atk: 137, def: 90, spa: 65, spd: 80, spe: 102},
		abilities: {0: "Intimidate", 1: "Moxie", H: "Anger Point"},
		heightm: 1.5,
		weightkg: 96.3,
		color: "Red",
	...
	darmanitan: {
		...
		baseForme: "Standard",
		types: ["Fire"],
		baseStats: {hp: 115, atk: 150, def: 65, spa: 30, spd: 65, spe: 105},
	...
	darmanitanzen: {
		...
		forme: "Zen",
		types: ["Fire", "Psychic"],
		baseStats: {hp: 115, atk: 30, def: 135, spa: 180, spd: 135, spe: 65},
	...
	maractus: {
		...
		name: "Maractus",
		types: ["Grass"],
		baseStats: {hp: 85, atk: 106, def: 77, spa: 116, spd: 77, spe: 70},
		abilities: {0: "Sand Rush", 1: "Scarecrow", H: "Storm Drain"},
		heightm: 1,
		weightkg: 28,
		color: "Green",
		eggGroups: ["Grass"],
	...
	crustle: {
		...
		name: "Crustle",
		types: ["Bug", "Rock"],
		baseStats: {hp: 70, atk: 125, def: 155, spa: 65, spd: 85, spe: 45},
		abilities: {0: "Sturdy", 1: "Shell Armor", H: "Heavy Shell"},
		heightm: 1.4,
		weightkg: 200,
		color: "Red",
		prevo: "Dwebble",
	...
	scrafty: {
		...
		name: "Scrafty",
		types: ["Dark", "Fighting"],
		baseStats: {hp: 65, atk: 100, def: 135, spa: 45, spd: 135, spe: 68},
		abilities: {0: "Heart Of The Gang", 1: "Moxie", H: "Intimidate"},
		heightm: 1.1,
		weightkg: 30,
		color: "Red",
		prevo: "Scraggy",
	...
	sigilyph: {
		...
		name: "Sigilyph",
		types: ["Psychic", "Flying"],
		baseStats: {hp: 82, atk: 58, def: 90, spa: 123, spd: 90, spe: 107},
		abilities: {0: "Runic Shield", 1: "Magic Guard", H: "Tinted Lens"},
		heightm: 1.4,
		weightkg: 14,
		color: "Black",
		eggGroups: ["Flying"],
	...
	cofagrigus: {
		...
		name: "Cofagrigus",
		types: ["Ghost"],
		baseStats: {hp: 58, atk: 50, def: 175, spa: 105, spd: 125, spe: 30},
		abilities: {0: "Mummy", H: "Haunted"},
		heightm: 1.7, 
		weightkg: 76.5,
		color: "Yellow",
		prevo: "Yamask",
	...
	carracosta: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 84, atk: 128, def: 153, spa: 93, spd: 65, spe: 32},
		abilities: {0: "Solid Rock", 1: "Sturdy Armor", H: "Swift Swim"},
		heightm: 1.2,
		weightkg: 81,
		color: "Blue",
		prevo: "Tirtouga",
	...
	archeops: {
		...
		types: ["Rock", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 160, def: 75, spa: 132, spd: 75, spe: 130},
		abilities: {0: "Defeatist"},
		heightm: 1.4,
		weightkg: 32,
		color: "Yellow",
	...
	garbodor: {
		...
		name: "Garbodor",
		types: ["Poison"],
		baseStats: {hp: 90, atk: 115, def: 102, spa: 60, spd: 102, spe: 75},
		abilities: {0: "Stench", 1: "Weak Armor", H: "Shambolic"},
		heightm: 1.9,
		weightkg: 107.3,
		color: "Green",
		prevo: "Trubbish",
	...
	zoroark: {
		...
		types: ["Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 125, def: 70, spa: 130, spd: 70, spe: 115},
		abilities: {0: "Illusion"},
		heightm: 1.6,
		weightkg: 81.1,
		color: "Gray",
	...
	zoroarkhisui: {
		...
		types: ["Normal", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 55, atk: 120, def: 70, spa: 135, spd: 70, spe: 120},
		abilities: {0: "Illusion"},
		heightm: 1.6,
		weightkg: 73,
		color: "Gray",
	...
	cinccino: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 85, atk: 105, def: 70, spa: 65, spd: 70, spe: 135},
		abilities: {0: "Multitasker", 1: "Technician", H: "Skill Link"},
		heightm: 0.5,
		weightkg: 7.5,
		color: "Gray",
		prevo: "Minccino",
	...
	gothitelle: {
		...
		types: ["Psychic"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 80, atk: 55, def: 105, spa: 115, spd: 130, spe: 65},
		abilities: {0: "Clairvoyance", 1: "Competitive", H: "Shadow Tag"},
		heightm: 1.5,
		weightkg: 44,
		color: "Purple",
		prevo: "Gothorita",
	...
	reuniclus: {
		...
		name: "Reuniclus",
		types: ["Psychic"],
		baseStats: {hp: 140, atk: 65, def: 75, spa: 145, spd: 95, spe: 30},
		abilities: {0: "Overcoat", 1: "Magic Guard", H: "Regenerator"},
		heightm: 1,
		weightkg: 20.1,
		color: "Green",
	...
	swanna: {
		...
		name: "Swanna",
		types: ["Water", "Flying"],
		baseStats: {hp: 75, atk: 107, def: 63, spa: 107, spd: 63, spe: 128},
		abilities: {0: "Mirror Wing", 1: "Big Pecks", H: "Hydration"},
		heightm: 1.3,
		weightkg: 24.2,
		color: "White",
		prevo: "Ducklett",
	...
	vanilluxe: {
		...
		name: "Vanilluxe",
		types: ["Ice"],
		baseStats: {hp: 81, atk: 95, def: 95, spa: 130, spd: 105, spe: 89},
	...
	sawsbuck: {
		...
		baseForme: "Spring",
		types: ["Normal", "Grass"],
		baseStats: {hp: 100, atk: 110, def: 80, spa: 60, spd: 80, spe: 105},
		abilities: {0: "Seasonal Strength", 1: "Sap Sipper", H: "Serene Grace"},
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
		prevo: "Deerling",
	...
	emolga: {
		...
		name: "Emolga",
		types: ["Electric", "Flying"],
		baseStats: {hp: 65, atk: 105, def: 60, spa: 105, spd: 60, spe: 113},
	...
	escavalier: {
		...
		name: "Escavalier",
		types: ["Bug", "Steel"],
		baseStats: {hp: 70, atk: 165, def: 125, spa: 60, spd: 115, spe: 20},
		abilities: {0: "En Garde", 1: "Shell Armor", H: "Overcoat"},
		heightm: 1,
		weightkg: 33,
		color: "Gray",
		prevo: "Karrablast",
	...
	amoonguss: {
		...
		name: "Amoonguss",
		types: ["Grass", "Poison"],
		baseStats: {hp: 134, atk: 95, def: 80, spa: 95, spd: 90, spe: 30},
		abilities: {0: "Effect Spore", H: "Regenerator"},
		heightm: 0.6,
		weightkg: 10.5,
		color: "White",
	...
	jellicent: {
		...
		name: "Jellicent",
		types: ["Water", "Ghost"],
		baseStats: {hp: 110, atk: 60, def: 80, spa: 105, spd: 125, spe: 60},
		abilities: {0: "Water Absorb", 1: "Soul Restore", H: "Damp"},
		heightm: 2.2,
		weightkg: 135,
		color: "White",
		prevo: "Frillish",
	...
	alomomola: {
		...
		name: "Alomomola",
		types: ["Water"],
		baseStats: {hp: 185, atk: 85, def: 90, spa: 40, spd: 55, spe: 75},
		abilities: {0: "Pixie Power", 1: "Hydration", H: "Regenerator"},
		heightm: 1.2,
		weightkg: 31.6,
		color: "Pink",
		eggGroups: ["Water 1", "Water 2"],
	...
	galvantula: {
		...
		name: "Galvantula",
		types: ["Bug", "Electric"],
		baseStats: {hp: 70, atk: 77, def: 70, spa: 117, spd: 70, spe: 128},
		abilities: {0: "Compound Eyes", 1: "Web Spit", H: "Swarm"},
		heightm: 0.8,
		weightkg: 14.3,
		color: "Yellow",
		prevo: "Joltik",
	...
	ferrothorn: {
		...
		name: "Ferrothorn",
		types: ["Grass", "Steel"],
		baseStats: {hp: 74, atk: 104, def: 151, spa: 54, spd: 126, spe: 20},
		abilities: {0: "Iron Barbs", H: "Thorn Trapper"},
		heightm: 1,
		weightkg: 110,
		color: "Gray",
		prevo: "Ferroseed",
	...
	klinklang: {
		...
		types: ["Steel"],
		gender: "N",
		baseStats: {hp: 60, atk: 110, def: 135, spa: 80, spd: 95, spe: 100},
		abilities: {0: "Plus", 1: "Gear Rotation", H: "Clear Body"},
		heightm: 0.6,
		weightkg: 81,
		color: "Gray",
		prevo: "Klang",
	...
	eelektross: {
		...
		name: "Eelektross",
		types: ["Electric"],
		baseStats: {hp: 85, atk: 125, def: 90, spa: 115, spd: 90, spe: 70},
	...
	beheeyem: {
		...
		name: "Beheeyem",
		types: ["Psychic"],
		baseStats: {hp: 85, atk: 75, def: 85, spa: 155, spd: 105, spe: 40},
		abilities: {0: "Mind Meld", 1: "Synchronize", H: "Analytic"},
		heightm: 1,
		weightkg: 34.5,
		color: "Brown",
		prevo: "Elgyem",
	...
	chandelure: {
		...
		name: "Chandelure",
		types: ["Ghost", "Fire"],
		baseStats: {hp: 70, atk: 55, def: 100, spa: 165, spd: 100, spe: 80},
		abilities: {0: "Flash Fire", 1: "Leaking Tar", H: "Infiltrator"},
		heightm: 1,
		weightkg: 34.3,
		color: "Black",
		prevo: "Lampent",
	...
	haxorus: {
		...
		name: "Haxorus",
		types: ["Dragon"],
		baseStats: {hp: 86, atk: 157, def: 100, spa: 60, spd: 70, spe: 107},
		abilities: {0: "Rivalry", 1: "Mold Breaker", H: "Armor Maw"},
		heightm: 1.8,
		weightkg: 105.5,
		color: "Yellow",
		prevo: "Fraxure",
	...
	beartic: {
		...
		name: "Beartic",
		types: ["Ice"],
		baseStats: {hp: 125, atk: 150, def: 80, spa: 70, spd: 80, spe: 60},
		abilities: {0: "Chilly Touch", 1: "Slush Rush", H: "Thick Fat"},
		heightm: 2.6,
		weightkg: 260,
		color: "White",
		prevo: "Cubchoo",
	...
	cryogonal: {
		...
		types: ["Ice"],
		gender: "N",
		baseStats: {hp: 90, atk: 50, def: 60, spa: 105, spd: 155, spe: 115},
		abilities: {0: "Levitate", H: "Glacial Reflection"},
		heightm: 1.1,
		weightkg: 148,
		color: "Blue",
		eggGroups: ["Mineral"],
	...
	accelgor: {
		...
		name: "Accelgor",
		types: ["Bug"],
		baseStats: {hp: 90, atk: 70, def: 40, spa: 120, spd: 70, spe: 165},
	...
	stunfisk: {
		...
		baseStats: {hp: 129, atk: 66, def: 104, spa: 91, spd: 129, spe: 32},
		abilities: {0: "Static", 1: "Mockery", H: "Sand Veil"},
		heightm: 0.7,
		weightkg: 11,
		color: "Brown",
		eggGroups: ["Water 1", "Amorphous"],
	...
	stunfiskgalar: {
		...
		forme: "Galar",
		types: ["Ground", "Steel"],
		baseStats: {hp: 129, atk: 91, def: 129, spa: 66, spd: 104, spe: 32},
		abilities: {0: "Mimicry", H: "Iron Barbs"},
		heightm: 0.7,
		weightkg: 20.5,
		color: "Green",
		eggGroups: ["Water 1", "Amorphous"],
	...
	mienshao: {
		...
		name: "Mienshao",
		types: ["Fighting"],
		baseStats: {hp: 85, atk: 135, def: 60, spa: 115, spd: 60, spe: 115},
		abilities: {0: "Graceful Combat", 1: "Regenerator", H: "Reckless"},
		heightm: 1.4,
		weightkg: 35.5,
		color: "Purple",
		prevo: "Mienfoo",
	...
	druddigon: {
		...
		name: "Druddigon",
		types: ["Dragon"],
		baseStats: {hp: 87, atk: 140, def: 110, spa: 60, spd: 110, spe: 48},
		abilities: {0: "Rough Skin", 1: "Sheer Force", H: "Boiling Fury"},
		heightm: 1.6,
		weightkg: 139,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	golurk: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: {hp: 99, atk: 144, def: 100, spa: 55, spd: 100, spe: 55},
		abilities: {0: "Iron Fist", 1: "Spirit Force", H: "No Guard"},
		heightm: 2.8,
		weightkg: 330,
		color: "Green",
		prevo: "Golett",
	...
	bisharp: {
		...
		name: "Bisharp",
		types: ["Dark", "Steel"],
		baseStats: {hp: 65, atk: 135, def: 110, spa: 60, spd: 70, spe: 70},
		abilities: {0: "Defiant", 1: "Inner Focus", H: "Graceful Combat"},
		heightm: 1.6,
		weightkg: 70,
		color: "Red",
		prevo: "Pawniard",
	...
	bouffalant: {
		...
		name: "Bouffalant",
		types: ["Normal"],
		baseStats: {hp: 115, atk: 130, def: 105, spa: 40, spd: 105, spe: 65},
		abilities: {0: "Reckless", 1: "Sap Sipper", H: "Cud Chew"},
		heightm: 1.6,
		weightkg: 94.6,
		color: "Brown",
		eggGroups: ["Field"],
	...
	braviary: {
		...
		types: ["Normal", "Flying"],
		gender: "M",
		baseStats: {hp: 120, atk: 133, def: 85, spa: 57, spd: 85, spe: 90},
		abilities: {0: "Skyward Soar", 1: "Sheer Force", H: "Defiant"},
		heightm: 1.5,
		weightkg: 41,
		color: "Red",
		prevo: "Rufflet",
	...
	braviaryhisui: {
		...
		types: ["Psychic", "Flying"],
		gender: "M",
		baseStats: {hp: 130, atk: 93, def: 70, spa: 122, spd: 70, spe: 75},
		abilities: {0: "Skyward Soar", 1: "Sheer Force", H: "Tinted Lens"},
		heightm: 1.7,
		weightkg: 43.4,
		color: "White",
		prevo: "Rufflet",
	...
	mandibuzz: {
		...
		types: ["Dark", "Flying"],
		gender: "F",
		baseStats: {hp: 130, atk: 75, def: 125, spa: 55, spd: 105, spe: 80},
		abilities: {0: "Schemer", 1: "Overcoat", H: "Weak Armor"},
		heightm: 1.2,
		weightkg: 39.5,
		color: "Brown",
		prevo: "Vullaby",
	...
	heatmor: {
		...
		name: "Heatmor",
		types: ["Fire"],
		baseStats: {hp: 105, atk: 117, def: 76, spa: 125, spd: 76, spe: 75},
		abilities: {0: "Gluttony", 1: "Flash Fire", H: "Molten Drain"},
		heightm: 1.4,
		weightkg: 58,
		color: "Red",
		eggGroups: ["Field"],
	...
	durant: {
		...
		name: "Durant",
		types: ["Bug", "Steel"],
		baseStats: {hp: 68, atk: 129, def: 132, spa: 48, spd: 58, spe: 119},
		abilities: {0: "Armor Maw", 1: "Hustle", H: "Truant"},
		heightm: 0.3,
		weightkg: 33,
		color: "Gray",
		eggGroups: ["Bug"],
	...
	hydreigon: {
		...
		name: "Hydreigon",
		types: ["Dark", "Dragon"],
		baseStats: {hp: 102, atk: 105, def: 90, spa: 145, spd: 90, spe: 98},
	...
	volcarona: {
		...
		name: "Volcarona",
		types: ["Bug", "Fire"],
		baseStats: {hp: 95, atk: 60, def: 65, spa: 135, spd: 105, spe: 110},
		abilities: {0: "Flame Body", H: "Solar Swarm"},
		heightm: 1.6,
		weightkg: 46,
		color: "White",
		prevo: "Larvesta",
	...
	cobalion: {
		...
		gender: "N",
		baseStats: {hp: 91, atk: 110, def: 139, spa: 110, spd: 72, spe: 118},
	...
	terrakion: {
		...
		types: ["Rock", "Fighting"],
		gender: "N",
		baseStats: {hp: 91, atk: 149, def: 100, spa: 72, spd: 100, spe: 118},
		abilities: {0: "Justified"},
		heightm: 1.9,
		weightkg: 260,
		color: "Gray",
	...
	virizion: {
		...
		types: ["Grass", "Fighting"],
		gender: "N",
		baseStats: {hp: 91, atk: 110, def: 72, spa: 110, spd: 139, spe: 118},
		abilities: {0: "Justified"},
		heightm: 2,
		weightkg: 200,
		color: "Green",
	...
	meloetta: {
		...
		types: ["Normal", "Psychic"],
		gender: "N",
		baseStats: {hp: 100, atk: 77, def: 77, spa: 138, spd: 148, spe: 110},
		abilities: {0: "Serene Grace"},
		heightm: 0.6,
		weightkg: 6.5,
		color: "White",
	...
	meloettapirouette: {
		...
		types: ["Normal", "Fighting"],
		gender: "N",
		baseStats: {hp: 100, atk: 148, def: 100, spa: 77, spd: 77, spe: 148},
		abilities: {0: "Serene Grace"},
		heightm: 0.6,
		weightkg: 6.5,
		color: "White",
	...
	chesnaught: {
		...
		types: ["Grass", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 98, atk: 127, def: 142, spa: 74, spd: 85, spe: 64},
	...
	delphox: {
		...
		types: ["Fire", "Psychic"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 85, atk: 69, def: 72, spa: 134, spd: 120, spe: 114},
		abilities: {0: "Spellcaster", H: "Magician"},
		heightm: 1.5,
		weightkg: 39,
		color: "Red",
		prevo: "Braixen",
	...
	greninja: {
		...
		types: ["Water", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 72, atk: 105, def: 67, spa: 113, spd: 71, spe: 132},
	...
	greninjaash: {
		...
		types: ["Water", "Dark"],
		gender: "M",
		baseStats: {hp: 72, atk: 155, def: 67, spa: 163, spd: 71, spe: 142},
		abilities: {0: "Battle Bond"},
		heightm: 1.5,
		weightkg: 40,
		color: "Blue",
	...
	diggersby: {
		...
		name: "Diggersby",
		types: ["Normal", "Ground"],
		baseStats: {hp: 105, atk: 76, def: 87, spa: 50, spd: 87, spe: 88},
		abilities: {0: "Pickup", 1: "Cheek Pouch", H: "Huge Power"},
		heightm: 1,
		weightkg: 42.4,
		color: "Brown",
	...
	talonflame: {
		...
		name: "Talonflame",
		types: ["Fire", "Flying"],
		baseStats: {hp: 78, atk: 101, def: 81, spa: 74, spd: 79, spe: 146},
		abilities: {0: "Flame Body",1: "Flame Touch", H: "Gale Wings"},
		heightm: 1.2,
		weightkg: 24.5,
		color: "Red",
		prevo: "Fletchinder",
	...
	vivillon: {
		...
		types: ["Bug", "Flying"],
		baseStats: {hp: 90, atk: 52, def: 60, spa: 100, spd: 60, spe: 109},
		abilities: {0: "Bright Wings", 1: "Compound Eyes", H: "Friend Guard"},
		heightm: 1.2,
		weightkg: 17,
		color: "White",
		prevo: "Spewpa",
	...
	pyroar: {
		...
		types: ["Fire", "Normal"],
		genderRatio: {M: 0.125, F: 0.875},
		baseStats: {hp: 86, atk: 98, def: 82, spa: 119, spd: 76, spe: 126},
		abilities: {0: "Rivalry", 1: "Majestic Aura", H: "Moxie"},
		heightm: 1.5,
		weightkg: 81.5,
		color: "Brown",
		prevo: "Litleo",
	...
	florges: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 88, atk: 65, def: 68, spa: 132, spd: 184, spe: 75},
		abilities: {0: "Floral Garden", H: "Symbiosis"},
		heightm: 1.1,
		weightkg: 10,
		color: "White",
		prevo: "Floette",
	...
	gogoat: {
		...
		name: "Gogoat",
		types: ["Grass"],
		baseStats: {hp: 143, atk: 110, def: 72, spa: 97, spd: 91, spe: 78},
		abilities: {0: "Sap Sipper",1: "Dairy Queen", H: "Grass Pelt"},
		heightm: 1.7,
		weightkg: 91,
		color: "Brown",
		prevo: "Skiddo",
	...
	pangoro: {
		...
		name: "Pangoro",
		types: ["Fighting", "Dark"],
		baseStats: {hp: 105, atk: 144, def: 88, spa: 69, spd: 81, spe: 68},
		abilities: {0: "Iron Fist", 1: "Mold Breaker", H: "Scrappy"},
		heightm: 2.1,
		weightkg: 136,
		color: "White",
	...
	furfrou: {
		...
		baseForme: "Natural",
		types: ["Normal"],
		baseStats: {hp: 95, atk: 100, def: 70, spa: 65, spd: 90, spe: 122},
	...
	meowstic: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 84, atk: 48, def: 86, spa: 93, spd: 101, spe: 124},
		abilities: {0: "Supporter", 1: "Infiltrator", H: "Prankster"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Blue",
		prevo: "Espurr",
	...
	meowsticf: {
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: {hp: 84, atk: 48, def: 76, spa: 113, spd: 91, spe: 124},
		abilities: {0: "Manipulator", 1: "Infiltrator", H: "Competitive"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "White",
		prevo: "Espurr",
	...
	aromatisse: {
		...
		name: "Aromatisse",
		types: ["Fairy"],
		baseStats: {hp: 121, atk: 72, def: 82, spa: 119, spd: 99, spe: 29},
		abilities: {0: "Polluted Air", H: "Aroma Veil"},
		heightm: 0.8,
		weightkg: 15.5,
		color: "Pink",
		prevo: "Spritzee",
	...
	slurpuff: {
		...
		name: "Slurpuff",
		types: ["Fairy"],
		baseStats: {hp: 92, atk: 80, def: 106, spa: 105, spd: 85, spe: 72},
		abilities: {0: "Sweet Veil", 1: "Sugar Rush", H: "Unburden"},
		heightm: 0.8,
		weightkg: 5,
		color: "White",
		prevo: "Swirlix",
	...
	malamar: {
		...
		name: "Malamar",
		types: ["Dark", "Psychic"],
		baseStats: {hp: 96, atk: 112, def: 108, spa: 68, spd: 85, spe: 73},
		abilities: {0: "Contrary", 1: "Upside Down", H: "Infiltrator"},
		heightm: 1.5,
		weightkg: 47,
		color: "Blue",
		prevo: "Inkay",
	...
	barbaracle: {
		...
		name: "Barbaracle",
		types: ["Rock", "Water"],
		baseStats: {hp: 72, atk: 135, def: 125, spa: 54, spd: 96, spe: 78},
		abilities: {0: "Tough Claws", 1: "Sniper", H: "Thievery"},
		heightm: 1.3,
		weightkg: 96,
		color: "Brown",
		prevo: "Binacle",
	...
	dragalge: {
		...
		name: "Dragalge",
		types: ["Poison", "Dragon"],
		baseStats: {hp: 75, atk: 95, def: 100, spa: 107, spd: 143, spe: 44},
		abilities: {0: "Poison Point", 1: "Water Absorb", H: "Adaptability"},
		heightm: 1.8,
		weightkg: 81.5,
		color: "Brown",
		prevo: "Skrelp",
	...
	clawitzer: {
		...
		name: "Clawitzer",
		types: ["Water"],
		baseStats: {hp: 71, atk: 73, def: 98, spa: 150, spd: 99, spe: 69},
		abilities: {0: "Mega Launcher"},
		heightm: 1.3,
		weightkg: 35.3,
		color: "Blue",
	...
	heliolisk: {
		...
		name: "Heliolisk",
		types: ["Electric", "Normal"],
		baseStats: {hp: 72, atk: 55, def: 52, spa: 129, spd: 104, spe: 129},
		abilities: {0: "Dry Skin", 1: "Amplify", H: "Solar Power"},
		heightm: 1,
		weightkg: 21,
		color: "Yellow",
		prevo: "Helioptile",
	...
	tyrantrum: {
		...
		types: ["Rock", "Dragon"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 92, atk: 141, def: 129, spa: 69, spd: 79, spe: 71},
	...
	aurorus: {
		...
		types: ["Rock", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 143, atk: 77, def: 82, spa: 119, spd: 102, spe: 58},
		abilities: {0: "Refrigerate", H: "Snow Warning"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	sylveon: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 65, def: 75, spa: 120, spd: 150, spe: 60},
	...
	hawlucha: {
		...
		name: "Hawlucha",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 88, atk: 112, def: 75, spa: 74, spd: 63, spe: 128},
		abilities: {0: "Acrobat", 1: "Unburden", H: "Mold Breaker"},
		heightm: 0.8,
		weightkg: 21.5,
		color: "Green",
	...
	dedenne: {
		...
		baseStats: {hp: 77, atk: 58, def: 57, spa: 101, spd: 77, spe: 121},
		abilities: {0: "Cheek Pouch", 1: "Amplify", H: "Plus"},
		heightm: 0.2,
		weightkg: 2.2,
		color: "Yellow",
		eggGroups: ["Field", "Fairy"],
	...
	carbink: {
		...
		types: ["Rock", "Fairy"],
		gender: "N",
		baseStats: {hp: 50, atk: 70, def: 170, spa: 70, spd: 170, spe: 50},
		abilities: {0: "Clear Body", H: "Magic Gems"},
		heightm: 0.3,
		weightkg: 5.7,
		color: "Gray",
		eggGroups: ["Fairy", "Mineral"],
	...
	goodra: {
		...
		name: "Goodra",
		types: ["Dragon"],
		baseStats: {hp: 100, atk: 110, def: 70, spa: 120, spd: 160, spe: 80},
		abilities: {0: "Sap Sipper", 1: "Squelch", H: "Gooey"},
		heightm: 2,
		weightkg: 150.5,
		color: "Purple",
		prevo: "Sliggoo",
	...
	goodrahisui: {
		...
		forme: "Hisui",
		types: ["Steel", "Dragon"],
		baseStats: {hp: 80, atk: 110, def: 100, spa: 120, spd: 150, spe: 60},
		abilities: {0: "Sap Sipper", 1: "Shell Armor", H: "Gooey"},
		heightm: 1.7,
		weightkg: 334.1,
		color: "Purple",
	...
	klefki: {
		...
		name: "Klefki",
		types: ["Steel", "Fairy"],
		baseStats: {hp: 67, atk: 90, def: 111, spa: 90, spd: 97, spe: 75},
	...
	trevenant: {
		...
		name: "Trevenant",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 105, atk: 130, def: 86, spa: 65, spd: 92, spe: 56},
		abilities: {0: "Cursed Roots", 1: "Frisk", H: "Harvest"},
		heightm: 1.5,
		weightkg: 71,
		color: "Brown",
		prevo: "Phantump",
	...
	gourgeist: {
		...
		baseForme: "Average",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 75, atk: 110, def: 132, spa: 58, spd: 85, spe: 94},
		abilities: {0: "Soul Restore", 1: "Frisk", H: "Insomnia"},
		heightm: 0.9,
		weightkg: 12.5,
		color: "Brown",
		prevo: "Pumpkaboo",
	...
	gourgeistsmall: {
		...
		forme: "Small",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 55, atk: 105, def: 132, spa: 58, spd: 85, spe: 119},
		abilities: {0: "Soul Restore", 1: "Frisk", H: "Insomnia"},
		heightm: 0.7,
		weightkg: 9.5,
		color: "Brown",
	...
	gourgeistlarge: {
		...
		forme: "Large",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 85, atk: 115, def: 132, spa: 58, spd: 85, spe: 79},
		abilities: {0: "Soul Restore", 1: "Frisk", H: "Insomnia"},
		heightm: 1.1,
		weightkg: 14,
		color: "Brown",
	...
	gourgeistsuper: {
		...
		forme: "Super",
		types: ["Ghost", "Grass"],
		baseStats: {hp: 105, atk: 120, def: 132, spa: 58, spd: 85, spe: 54},
		abilities: {0: "Soul Restore", 1: "Frisk", H: "Insomnia"},
		heightm: 1.7,
		weightkg: 39,
		color: "Brown",
	...
	avalugg: {
		...
		name: "Avalugg",
		types: ["Ice"],
		baseStats: {hp: 105, atk: 127, def: 214, spa: 44, spd: 56, spe: 28},
		abilities: {0: "Chilly Touch", 1: "Glacial Reflection", H: "Sturdy"},
		heightm: 2,
		weightkg: 505,
		color: "Blue",
		prevo: "Bergmite",
	...
	avalugghisui: {
		...
		forme: "Hisui",
		types: ["Ice", "Rock"],
		baseStats: {hp: 105, atk: 137, def: 204, spa: 34, spd: 46, spe: 38},
	...
	noivern: {
		...
		name: "Noivern",
		types: ["Flying", "Dragon"],
		baseStats: {hp: 85, atk: 70, def: 90, spa: 117, spd: 90, spe: 143},
		abilities: {0: "Frisk", 1: "Infiltrator", H: "Deafening"},
		heightm: 1.5,
		weightkg: 85,
		color: "Purple",
		prevo: "Noibat",
	...
	volcanion: {
		...
		types: ["Fire", "Water"],
		gender: "N",
		baseStats: {hp: 90, atk: 120, def: 120, spa: 140, spd: 90, spe: 70},
	...
	decidueye: {
		...
		types: ["Grass", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 88, atk: 127, def: 85, spa: 110, spd: 110, spe: 70},
		abilities: {0: "Archer", H: "Long Reach"},
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
		prevo: "Dartrix",
	...
	decidueyehisui: {
		...
		types: ["Grass", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 88, atk: 132, def: 80, spa: 105, spd: 105, spe: 70},
		abilities: {0: "Long Reach", H: "Scrappy"},
		heightm: 1.6,
		weightkg: 37,
		color: "Brown",
		prevo: "Dartrix",
	...
	incineroar: {
		...
		types: ["Fire", "Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 105, atk: 135, def: 100, spa: 90, spd: 100, spe: 60},
		abilities: {0: "Adrenaline", H: "Intimidate"},
		heightm: 1.8,
		weightkg: 83,
		color: "Red",
		prevo: "Torracat",
	...
	primarina: {
		...
		types: ["Water", "Fairy"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 74, def: 84, spa: 146, spd: 136, spe: 60},
		abilities: {0: "Ocean Veil", H: "Liquid Voice"},
		heightm: 1.8,
		weightkg: 44,
		color: "Blue",
		prevo: "Brionne",
	...
	toucannon: {
		...
		name: "Toucannon",
		types: ["Normal", "Flying"],
		baseStats: {hp: 100, atk: 140, def: 85, spa: 75, spd: 85, spe: 70},
		abilities: {0: "Heated Beak", 1: "Skill Link", H: "Sheer Force"},
		heightm: 1.1,
		weightkg: 26,
		color: "Black",
		prevo: "Trumbeak",
	...
	gumshoostotem: {
		...
		forme: "Totem",
		types: ["Normal"],
		baseStats: {hp: 128, atk: 140, def: 80, spa: 55, spd: 80, spe: 35},
		abilities: {0: "Adaptability"},
		heightm: 1.4,
		weightkg: 60,
		color: "Brown",
	...
	vikavolt: {
		...
		name: "Vikavolt",
		types: ["Bug", "Electric"],
		baseStats: {hp: 87, atk: 70, def: 110, spa: 165, spd: 75, spe: 53},
	...
	vikavolttotem: {
		...
		forme: "Totem",
		types: ["Bug", "Electric"],
		baseStats: {hp: 107, atk: 70, def: 120, spa: 175, spd: 75, spe: 43},
		abilities: {0: "Levitate", H: "Speed Boost"},
		heightm: 2.6,
		weightkg: 147.5,
		color: "Blue",
	...
	crabominable: {
		...
		name: "Crabominable",
		types: ["Fighting", "Ice"],
		baseStats: {hp: 117, atk: 162, def: 87, spa: 62, spd: 67, spe: 43},
		abilities: {0: "Chilly Touch", 1: "Iron Fist", H: "Anger Point"},
		heightm: 1.7,
		weightkg: 180,
		color: "White",
		prevo: "Crabrawler",
	...
	oricorio: {
		...
		types: ["Fire", "Flying"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 85, atk: 70, def: 90, spa: 118, spd: 80, spe: 113},
		abilities: {0: "Dancer"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Red",
	...
	oricoriopompom: {
		...
		types: ["Electric", "Flying"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 85, atk: 70, def: 80, spa: 108, spd: 80, spe: 133},
		abilities: {0: "Dancer"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Yellow",
	...
	oricoriopau: {
		...
		types: ["Psychic", "Flying"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 85, atk: 70, def: 80, spa: 128, spd: 90, spe: 103},
		abilities: {0: "Dancer"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Pink",
	...
	oricoriosensu: {
		...
		types: ["Ghost", "Flying"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 85, atk: 70, def: 70, spa: 118, spd: 100, spe: 113},
		abilities: {0: "Dancer"},
		heightm: 0.6,
		weightkg: 3.4,
		color: "Purple",
	...
	ribombee: {
		...
		name: "Ribombee",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 60, atk: 55, def: 70, spa: 115, spd: 90, spe: 134},
		abilities: {0: "Fluttering Bug", 1: "Shield Dust", H: "Sweet Veil"},
		heightm: 0.2,
		weightkg: 0.5,
		color: "Yellow",
		prevo: "Cutiefly",
	...
	ribombeetotem: {
		...
		forme: "Totem",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 60, atk: 55, def: 70, spa: 125, spd: 110, spe: 124},
		abilities: {0: "Sweet Veil", H: "Fluttering Bug"},
		heightm: 0.4,
		weightkg: 2,
		color: "Yellow",
		eggGroups: ["Bug", "Fairy"],
	...
	lycanroc: {
		...
		baseForme: "Midday",
		types: ["Rock"],
		baseStats: {hp: 85, atk: 125, def: 75, spa: 55, spd: 75, spe: 132},
		abilities: {0: "Roughen Up", 1: "Sand Rush", H: "Steadfast"},
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "Rockruff",
	...
	lycanrocmidnight: {
		...
		forme: "Midnight",
		types: ["Rock"],
		baseStats: {hp: 95, atk: 135, def: 85, spa: 55, spd: 85, spe: 92},
		abilities: {0: "Roughen Up", 1: "Vital Spirit", H: "No Guard"},
		heightm: 1.1,
		weightkg: 25,
		color: "Red",
		prevo: "Rockruff",
	...
	lycanrocdusk: {
		...
		forme: "Dusk",
		types: ["Rock"],
		baseStats: {hp: 95, atk: 127, def: 75, spa: 55, spd: 75, spe: 120},
		abilities: {0: "Tough Claws", 1: "Roughen Up"},
		heightm: 0.8,
		weightkg: 25,
		color: "Brown",
		prevo: "Rockruff",
	...
	wishiwashi: {
		...
		baseForme: "Solo",
		types: ["Water"],
		baseStats: {hp: 45, atk: 20, def: 20, spa: 25, spd: 25, spe: 110},
	...
	toxapex: {
		...
		name: "Toxapex",
		types: ["Poison", "Water"],
		baseStats: {hp: 50, atk: 73, def: 162, spa: 53, spd: 152, spe: 35},
		abilities: {0: "Merciless", 1: "Limber", H: "Regenerator"},
		heightm: 0.7,
		weightkg: 14.5,
		color: "Blue",
	...
	mudsdale: {
		...
		name: "Mudsdale",
		types: ["Ground"],
		baseStats: {hp: 110, atk: 145, def: 120, spa: 55, spd: 95, spe: 35},
		abilities: {0: "Own Tempo", 1: "Stamina", H: "Sand Force"},
		heightm: 2.5,
		weightkg: 920,
		color: "Brown",
		prevo: "Mudbray",
	...
	araquanid: {
		...
		name: "Araquanid",
		types: ["Water", "Bug"],
		baseStats: {hp: 78, atk: 90, def: 102, spa: 50, spd: 152, spe: 42},
		abilities: {0: "Water Bubble", H: "Water Absorb"},
		heightm: 1.8,
		weightkg: 82,
		color: "Green",
	...
	araquanidtotem: {
		...
		forme: "Totem",
		types: ["Water", "Bug"],
		baseStats: {hp: 88, atk: 90, def: 102, spa: 50, spd: 142, spe: 42},
	...
	lurantis: {
		...
		name: "Lurantis",
		types: ["Grass"],
		baseStats: {hp: 80, atk: 125, def: 110, spa: 90, spd: 110, spe: 45},
		abilities: {0: "Floral Enhance", H: "Contrary"},
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
		prevo: "Fomantis",
	...
	lurantistotem: {
		...
		forme: "Totem",
		types: ["Grass"],
		baseStats: {hp: 90, atk: 125, def: 110, spa: 80, spd: 110, spe: 45},
		abilities: {0: "Floral Enhance"},
		heightm: 1.5,
		weightkg: 58,
		color: "Pink",
		eggGroups: ["Grass"],
	...
	shiinotic: {
		...
		name: "Shiinotic",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 80, atk: 45, def: 100, spa: 120, spd: 130, spe: 30},
		abilities: {0: "Bioluminescent", 1: "Effect Spore", H: "Rain Dish"},
		heightm: 1,
		weightkg: 11.5,
		color: "Purple",
		prevo: "Morelull",
	...
	salazzle: {
		...
		types: ["Poison", "Fire"],
		gender: "F",
		baseStats: {hp: 78, atk: 84, def: 60, spa: 121, spd: 60, spe: 137},
		abilities: {0: "Corrosion", H: "Lethal Claw"},
		heightm: 1.2,
		weightkg: 22.2,
		color: "Black",
		prevo: "Salandit",
	...
	salazzletotem: {
		...
		types: ["Poison", "Fire"],
		gender: "F",
		baseStats: {hp: 78, atk: 104, def: 60, spa: 121, spd: 60, spe: 117},
		abilities: {0: "Corrosion", H: "Lethal Claw"},
		heightm: 2.1,
		weightkg: 81,
		color: "Black",
	...
	bewear: {
		...
		name: "Bewear",
		types: ["Normal", "Fighting"],
		baseStats: {hp: 140, atk: 135, def: 90, spa: 55, spd: 70, spe: 60},
	...
	tsareena: {
		...
		types: ["Grass"],
		gender: "F",
		baseStats: {hp: 82, atk: 130, def: 108, spa: 50, spd: 108, spe: 92},
		abilities: {0: "Majestic Aura", 1: "Queenly Majesty", H: "Sweet Veil"},
		heightm: 1.2,
		weightkg: 21.4,
		color: "Purple",
		prevo: "Steenee",
	...
	comfey: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 51, atk: 52, def: 100, spa: 92, spd: 130, spe: 110},
	...
	oranguru: {
		...
		name: "Oranguru",
		types: ["Normal", "Psychic"],
		baseStats: {hp: 100, atk: 60, def: 90, spa: 110, spd: 130, spe: 60},
		abilities: {0: "Magic Field", 1: "Telepathy", H: "Symbiosis"},
		heightm: 1.5,
		weightkg: 76,
		color: "White",
		eggGroups: ["Field"],
	...
	passimian: {
		...
		name: "Passimian",
		types: ["Fighting"],
		baseStats: {hp: 120, atk: 130, def: 100, spa: 40, spd: 60, spe: 100},
		abilities: {0: "Receiver", 1:"Baller", H: "Defiant"},
		heightm: 2,
		weightkg: 82.8,
		color: "White",
		eggGroups: ["Field"],
	...
	golisopod: {
		...
		name: "Golisopod",
		types: ["Bug", "Water"],
		baseStats: {hp: 85, atk: 155, def: 150, spa: 60, spd: 100, spe: 40},
	...
	palossand: {
		...
		name: "Palossand",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 85, atk: 75, def: 130, spa: 120, spd: 95, spe: 35},
		abilities: {0: "Water Compaction", 1: "Chaos Infliction", H: "Sand Stream"},
		heightm: 1.3,
		weightkg: 250,
		color: "Brown",
		prevo: "Sandygast",
	...
	pyukumuku: {
		...
		name: "Pyukumuku",
		types: ["Water"],
		baseStats: {hp: 65, atk: 60, def: 150, spa: 30, spd: 150, spe: 5},
	...
	typenull: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 95, atk: 105, def: 105, spa: 105, spd: 105, spe: 59},
	...
	silvally: {
		...
		types: ["Normal"],
		gender: "N",
		baseStats: {hp: 105, atk: 115, def: 105, spa: 115, spd: 105, spe: 105},
	...
	minior: {
		...
		types: ["Rock", "Flying"],
		gender: "N",
		baseStats: {hp: 60, atk: 120, def: 60, spa: 120, spd: 60, spe: 140},
	...
	miniormeteor: {
		...
		types: ["Rock", "Flying"],
		gender: "N",
		baseStats: {hp: 60, atk: 80, def: 120, spa: 80, spd: 120, spe: 60},
		abilities: {0: "Shields Down"},
		heightm: 0.3,
		weightkg: 40,
		color: "Brown",
	...
	komala: {
		...
		name: "Komala",
		types: ["Normal"],
		baseStats: {hp: 85, atk: 125, def: 75, spa: 75, spd: 105, spe: 75},
	...
	turtonator: {
		...
		name: "Turtonator",
		types: ["Fire", "Dragon"],
		baseStats: {hp: 70, atk: 78, def: 155, spa: 111, spd: 95, spe: 36},
		abilities: {0: "Heated Shell"},
		heightm: 2,
		weightkg: 212,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	togedemaru: {
		...
		name: "Togedemaru",
		types: ["Electric", "Steel"],
		baseStats: {hp: 75, atk: 118, def: 83, spa: 40, spd: 93, spe: 116},
	...
	togedemarutotem: {
		...
		forme: "Totem",
		types: ["Electric", "Steel"],
		baseStats: {hp: 75, atk: 128, def: 83, spa: 40, spd: 93, spe: 106},
		abilities: {0: "Sturdy"},
		heightm: 0.6,
		weightkg: 13,
		color: "Gray",
	...
	mimikyu: {
		...
		baseForme: "Disguised",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 120, def: 90, spa: 50, spd: 115, spe: 86},
	...
	mimikyubusted: {
		...
		forme: "Busted",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 100, def: 90, spa: 50, spd: 115, spe: 106},
		abilities: {0: "Disguise"},
		heightm: 0.2,
		weightkg: 0.7,
		color: "Yellow",
	...
	mimikyutotem: {
		...
		forme: "Totem",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 130, def: 90, spa: 50, spd: 115, spe: 76},
		abilities: {0: "Disguise"},
		heightm: 0.4,
		weightkg: 2.8,
		color: "Yellow",
	...
	mimikyubustedtotem: {
		...
		forme: "Busted-Totem",
		types: ["Ghost", "Fairy"],
		baseStats: {hp: 55, atk: 110, def: 90, spa: 50, spd: 115, spe: 96},
		abilities: {0: "Disguise"},
		heightm: 0.4,
		weightkg: 2.8,
		color: "Yellow",
	...
	bruxish: {
		...
		name: "Bruxish",
		types: ["Water", "Psychic"],
		baseStats: {hp: 68, atk: 125, def: 80, spa: 70, spd: 80, spe: 112},
		abilities: {0: "Dazzling", 1: "Strong Jaw", H: "Schemer"},
		heightm: 0.9,
		weightkg: 19,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	drampa: {
		...
		name: "Drampa",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 98, atk: 60, def: 85, spa: 165, spd: 101, spe: 36},
		abilities: {0: "Berserk", 1: "Sap Sipper", H: "Clear Clouds"},
		heightm: 3,
		weightkg: 185,
		color: "White",
		eggGroups: ["Monster", "Dragon"],
	...
	dhelmise: {
		...
		types: ["Ghost", "Grass"],
		gender: "N",
		baseStats: {hp: 70, atk: 151, def: 120, spa: 86, spd: 110, spe: 40},
		abilities: {0: "Steelworker", H:"Spirit FOrce"},
		heightm: 3.9,
		weightkg: 210,
		color: "Green",
		eggGroups: ["Mineral"],
	...
	kommoo: {
		...
		name: "Kommo-o",
		types: ["Dragon", "Fighting"],
		baseStats: {hp: 75, atk: 120, def: 125, spa: 110, spd: 105, spe: 85},
		abilities: {0: "Bulletproof", 1: "Soundproof", H: "Overcoat"},
		heightm: 1.6,
		weightkg: 78.2,
		color: "Gray",
	...
	kommoototem: {
		...
		forme: "Totem",
		types: ["Dragon", "Fighting"],
		baseStats: {hp: 85, atk: 120, def: 125, spa: 110, spd: 105, spe: 75},
	...
	cosmoem: {
		...
		types: ["Psychic"],
		gender: "N",
		baseStats: {hp: 43, atk: 29, def: 161, spa: 29, spd: 161, spe: 37},
		abilities: {0: "Sturdy"},
		heightm: 0.1,
		weightkg: 999.9,
		color: "Blue",
	...
	nihilego: {
		...
		types: ["Rock", "Poison"],
		gender: "N",
		baseStats: {hp: 119, atk: 53, def: 47, spa: 137, spd: 141, spe: 113},
